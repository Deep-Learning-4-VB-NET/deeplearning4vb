...
Namespace org.datavec.local.transforms.analysis.histogram
	...
	Public Class HistogramCombineFunction
		Implements BiFunction(Of IList(Of HistogramCounter), IList(Of HistogramCounter), IList(Of HistogramCounter))

		Public Overridable Function apply(ByVal l1 As IList(Of HistogramCounter), ByVal l2 As IList(Of HistogramCounter)) As IList(Of HistogramCounter)
