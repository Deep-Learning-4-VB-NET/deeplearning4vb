...
'ORIGINAL LINE: @AllArgsConstructor public class SequenceWritablesToStringFunction implements org.nd4j.common.function.@Function<java.util.List<java.util.List<org.datavec.api.writable.Writable>>, String>
	Public Class SequenceWritablesToStringFunction
		...
		Public Overridable Function apply(ByVal c As IList(Of IList(Of Writable))) As String
