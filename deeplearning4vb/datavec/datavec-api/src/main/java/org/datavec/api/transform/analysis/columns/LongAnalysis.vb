...
'ORIGINAL LINE: @EqualsAndHashCode(callSuper = true) @Data @NoArgsConstructor public class LongAnalysis extends NumericalColumnAnalysis
	<Serializable>
	Public Class LongAnalysis
		...
		Public Overrides Function ToString() As String
			Return "LongAnalysis(min=" & min & ",max=" & max & "," & MyBase.ToString() & ")"
		End Function
...
'JAVA TO VB CONVERTER NOTE: The parameter max was renamed since Visual Basic will not allow parameters with the same name as their enclosing function or property:
			...
			Public Overridable Function build() As LongAnalysis
				Return New LongAnalysis(Me)
			End Function
		End Class
