...
'ORIGINAL LINE: @AllArgsConstructor @Data public class LongAnalysisCounter implements org.datavec.api.transform.analysis.AnalysisCounter<LongAnalysisCounter>
	Public Class LongAnalysisCounter
		Implements AnalysisCounter(Of LongAnalysisCounter)
		...
		Public Overridable ReadOnly Property MinValueSeen As Long
			Get
				Return CLng(Math.Truncate(counter.Min))
			End Get
		End Property

		Public Overridable ReadOnly Property MaxValueSeen As Long
			Get
				Return CLng(Math.Truncate(counter.Max))
			End Get
		End Property
		...
		Public Overridable Function add(ByVal writable As Writable) As LongAnalysisCounter
			Dim value As Long = writable.toLong()
		...
		Public Overridable Function merge(ByVal other As LongAnalysisCounter) As LongAnalysisCounter
			Dim otherMin As Long = other.MinValueSeen
			...
			Dim otherMax As Long = other.MaxValueSeen
			...
			Return New LongAnalysisCounter(counter.merge(other.getCounter()), countZero + other.getCountZero(), newCountMinValue, newCountMaxValue, countPositive + other.getCountPositive(), countNegative + other.getCountNegative(), digest)
		End Function
	End Class
