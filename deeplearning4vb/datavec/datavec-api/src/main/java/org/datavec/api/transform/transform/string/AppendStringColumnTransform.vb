...
'ORIGINAL LINE: @JsonIgnoreProperties({"inputSchema", "columnNumber"}) @Data public class AppendStringColumnTransform extends org.datavec.api.transform.transform.BaseColumnTransform
	<Serializable>
	Public Class AppendStringColumnTransform
		Inherits BaseColumnTransform

		Private toAppend As String

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public AppendStringColumnTransform(@JsonProperty("columnName") String columnName, @JsonProperty("toAppend") String toAppend)
		Public Sub New(ByVal columnName As String, ByVal toAppend As String)
			MyBase.New(columnName)
			Me.toAppend = toAppend
		End Sub
