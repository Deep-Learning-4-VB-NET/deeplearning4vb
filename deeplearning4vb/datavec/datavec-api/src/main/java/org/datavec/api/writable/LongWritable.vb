...
'ORIGINAL LINE: public LongWritable(@JsonProperty("value") long value)
		Public Sub New(ByVal value As Long)
			set(value)
		End Sub

		''' <summary>
		''' Set the value of this LongWritable. </summary>
		Public Overridable Sub set(ByVal value As Long)
			Me.value = value
		End Sub

		''' <summary>
		''' Return the value of this LongWritable. </summary>
...
'ORIGINAL LINE: public void write(java.io.DataOutput out) throws java.io.IOException
		...
		''' <summary>
		''' Returns true iff <code>o</code> is a LongWritable with the same value. </summary>
		...
		Public Overrides Function GetHashCode() As Integer
			...
			Return CInt(value Xor CLng(CULng(value) >> 32))
		End Function

		''' <summary>
		''' Compares two LongWritables. </summary>
		Public Overridable Function compareTo(ByVal o As Object) As Integer
			Dim thisValue As Long = Me.value
			Dim thatValue As Long = DirectCast(o, LongWritable).value
		...
		''' <summary>
		''' A Comparator optimized for LongWritable. </summary>
		Public Class Comparator
			Inherits WritableComparator

			Public Sub New()
				MyBase.New(GetType(LongWritable))
			End Sub
			...
			Public Overrides Function compare(ByVal b1() As SByte, ByVal s1 As Integer, ByVal l1 As Integer, ByVal b2() As SByte, ByVal s2 As Integer, ByVal l2 As Integer) As Integer
				Dim thisValue As Long = readLong(b1, s1)
				Dim thatValue As Long = readLong(b2, s2)
				Return (If(thisValue < thatValue, -1, (If(thisValue = thatValue, 0, 1))))
			End Function
		End Class

		''' <summary>
		''' A decreasing Comparator optimized for LongWritable. </summary>
		Public Class DecreasingComparator
			Inherits Comparator

			Public Overridable Overloads Function compare(ByVal a As WritableComparable, ByVal b As WritableComparable) As Integer
				Return -MyBase.compare(a, b)
			End Function

			Public Overrides Function compare(ByVal b1() As SByte, ByVal s1 As Integer, ByVal l1 As Integer, ByVal b2() As SByte, ByVal s2 As Integer, ByVal l2 As Integer) As Integer
				Return -MyBase.compare(b1, s1, l1, b2, s2, l2)
			End Function
		End Class

		Shared Sub New() ' register default comparator
			WritableComparator.define(GetType(LongWritable), New Comparator())
		End Sub
