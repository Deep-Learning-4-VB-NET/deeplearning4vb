...
Namespace org.datavec.api.transform.reduce
	...
	Public Interface ColumnReduction
		...
		Function reduceColumn(ByVal columnData As IList(Of Writable)) As Writable
		...
		Function getColumnOutputName(ByVal columnInputName As String) As String
		...
		Function getColumnOutputMetaData(ByVal newColumnName As String, ByVal columnInputMeta As ColumnMetaData) As ColumnMetaData
