...
'ORIGINAL LINE: @AllArgsConstructor public class TimeQualityAddFunction implements org.nd4j.common.function.BiFunction<org.datavec.api.transform.quality.columns.TimeQuality, org.datavec.api.writable.Writable, org.datavec.api.transform.quality.columns.TimeQuality>, java.io.Serializable
	<Serializable>
	Public Class TimeQualityAddFunction
		Implements BiFunction(Of TimeQuality, Writable, TimeQuality)

		Private ReadOnly meta As TimeMetaData

		Public Overridable Function apply(ByVal v1 As TimeQuality, ByVal writable As Writable) As TimeQuality
