...
'ORIGINAL LINE: @AllArgsConstructor @Data public class RecordMetaDataInterval implements RecordMetaData
	<Serializable>
	Public Class RecordMetaDataInterval
		Implements RecordMetaData

		Private ReadOnly from As Long
		Private ReadOnly [to] As Long
...
'JAVA TO VB CONVERTER NOTE: The field readerClass was renamed since Visual Basic does not allow fields to have the same name as other class members:
		...
		Public Sub New(ByVal from As Long, ByVal [to] As Long, ByVal uri As URI)
			Me.New(from, [to], uri, Nothing)
		End Sub
