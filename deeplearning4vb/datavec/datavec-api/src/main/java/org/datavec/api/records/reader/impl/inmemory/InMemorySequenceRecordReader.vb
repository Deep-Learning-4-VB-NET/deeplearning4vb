...
'ORIGINAL LINE: @Data public class InMemorySequenceRecordReader implements org.datavec.api.records.reader.SequenceRecordReader
	<Serializable>
	Public Class InMemorySequenceRecordReader
		Implements SequenceRecordReader

		Private records As IList(Of IList(Of IList(Of Writable)))
		Private iter As IEnumerator(Of IList(Of IList(Of Writable)))
		...
		Public Sub New(ByVal records As IList(Of IList(Of IList(Of Writable))))
			Me.records = records
