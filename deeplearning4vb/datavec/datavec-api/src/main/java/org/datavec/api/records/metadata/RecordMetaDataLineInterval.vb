...
'ORIGINAL LINE: @AllArgsConstructor @Data public class RecordMetaDataLineInterval implements RecordMetaData
	<Serializable>
	Public Class RecordMetaDataLineInterval
		Implements RecordMetaData

		Private lineNumberStart As Integer
		Private lineNumberEnd As Integer
