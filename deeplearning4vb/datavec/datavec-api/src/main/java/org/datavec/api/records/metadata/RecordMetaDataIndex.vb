...
'ORIGINAL LINE: @AllArgsConstructor @Data public class RecordMetaDataIndex implements RecordMetaData
	<Serializable>
	Public Class RecordMetaDataIndex
		Implements RecordMetaData

		Private ReadOnly index As Long
