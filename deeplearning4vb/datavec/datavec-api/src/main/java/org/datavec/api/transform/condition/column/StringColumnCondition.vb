...
'ORIGINAL LINE: @EqualsAndHashCode(callSuper = true) @Data public class StringColumnCondition extends BaseColumnCondition
	<Serializable>
	Public Class StringColumnCondition
		...
		''' <param name="op">                    Operation (== or != only) </param>
		''' <param name="value">                 Value to use in the condition </param>
		Public Sub New(ByVal column As String, ByVal sequenceConditionMode As SequenceConditionMode, ByVal op As ConditionOp, ByVal value As String)
		...
		Public Sub New(ByVal column As String, ByVal op As ConditionOp, ByVal set As ISet(Of String))
		...
		''' <param name="op">                    Operation. Must be either ConditionOp.InSet, ConditionOp.NotInSet </param>
		''' <param name="set">                   Set to use in the condition </param>
		Public Sub New(ByVal column As String, ByVal sequenceConditionMode As SequenceConditionMode, ByVal op As ConditionOp, ByVal set As ISet(Of String))
			MyBase.New(column, sequenceConditionMode)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: private StringColumnCondition(@JsonProperty("columnName") String columnName, @JsonProperty("op") org.datavec.api.transform.condition.ConditionOp op, @JsonProperty("value") String value, @JsonProperty("set") java.util.@Set<String> set)
		...
		Public Overrides Function ToString() As String
			Return "StringColumnCondition(columnName=""" & columnName_Conflict & """," & op & "," & (If(op = ConditionOp.NotInSet OrElse op = ConditionOp.InSet, set, value)) & ")"
		End Function
