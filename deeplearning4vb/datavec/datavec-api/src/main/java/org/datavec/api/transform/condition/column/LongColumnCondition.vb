...
'ORIGINAL LINE: @EqualsAndHashCode(callSuper = true) @Data public class LongColumnCondition extends BaseColumnCondition
	<Serializable>
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: private LongColumnCondition(@JsonProperty("columnName") String columnName, @JsonProperty("op") org.datavec.api.transform.condition.ConditionOp op, @JsonProperty("value") long value, @JsonProperty("set") java.util.@Set<Long> set)
		...
		Public Overrides Function ToString() As String
			Return "LongColumnCondition(columnName=""" & columnName_Conflict & """," & op & "," & (If(op = ConditionOp.NotInSet OrElse op = ConditionOp.InSet, set, value)) & ")"
		End Function
