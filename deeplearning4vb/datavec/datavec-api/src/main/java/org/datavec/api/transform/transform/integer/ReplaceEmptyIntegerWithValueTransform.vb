...
'ORIGINAL LINE: @EqualsAndHashCode(callSuper = true) @Data public class ReplaceEmptyIntegerWithValueTransform extends BaseIntegerTransform
	<Serializable>
	Public Class ReplaceEmptyIntegerWithValueTransform
		Inherits BaseIntegerTransform

		Private ReadOnly value As Integer

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public ReplaceEmptyIntegerWithValueTransform(@JsonProperty("columnName") String columnName, @JsonProperty("value") int value)
