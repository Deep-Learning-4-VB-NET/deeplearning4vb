...
'ORIGINAL LINE: @Data @EqualsAndHashCode(callSuper = true) public class BinaryMetaData extends BaseColumnMetaData
	<Serializable>
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public BinaryMetaData(@JsonProperty("name") String name)
		...
		Public Overrides Function clone() As BinaryMetaData
			Return New BinaryMetaData(name_Conflict)
		End Function

		Public Overrides Function ToString() As String
			Dim sb As New StringBuilder()
			sb.Append("BinaryMetaData(name=""").Append(name_Conflict).Append(""",")
			sb.Append(")")
			Return sb.ToString()
		End Function
	End Class
