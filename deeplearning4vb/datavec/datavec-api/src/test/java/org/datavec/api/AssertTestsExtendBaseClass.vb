	...
	Public Class AssertTestsExtendBaseClass
		...
		Protected Friend Overrides ReadOnly Property Exclusions As ISet(Of [Class])
			Get
				...
				Dim res As ISet(Of Type) = New HashSet(Of Type)()
				res.Add(GetType(CustomCondition))
				res.Add(GetType(CustomFilter))
				res.Add(GetType(CustomTransform))
				Return res
			End Get
		End Property
