...
Imports WritablesToNDArrayFunction = org.datavec.spark.transform.misc.WritablesToNDArrayFunction
...
'ORIGINAL LINE: @Tag(TagNames.FILE_IO) @Tag(TagNames.SPARK) @Tag(TagNames.DIST_SYSTEMS) @NativeTag public class TestWritablesToNDArrayFunction
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub testWritablesToNDArrayAllScalars()
			...
			Next i
			Dim expected As INDArray = Nd4j.arange(5).castTo(DataType.FLOAT).reshape(ChrW(1), 5)
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub testWritablesToNDArrayMixed()
			...
			Dim arr As INDArray = Nd4j.arange(2, 5)
