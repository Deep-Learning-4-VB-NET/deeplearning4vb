...
Namespace org.datavec.spark.functions.data
	...
	Public Class SequenceRecordReaderBytesFunction
		Implements [Function](Of Tuple2(Of Text, BytesWritable), IList(Of IList(Of Writable)))
...
'ORIGINAL LINE: @Override public java.util.List<java.util.List<org.datavec.api.writable.Writable>> call(scala.Tuple2<org.apache.hadoop.io.Text, org.apache.hadoop.io.BytesWritable> v1) throws Exception
		Public Overrides Function [call](ByVal v1 As Tuple2(Of Text, BytesWritable)) As IList(Of IList(Of Writable))
