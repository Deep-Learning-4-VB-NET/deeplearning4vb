...
'ORIGINAL LINE: @AllArgsConstructor public class NDArrayToWritablesFunction implements org.apache.spark.api.java.function.@Function<org.nd4j.linalg.api.ndarray.INDArray, java.util.List<org.datavec.api.writable.Writable>>
...
'ORIGINAL LINE: @Override public java.util.List<org.datavec.api.writable.Writable> call(org.nd4j.linalg.api.ndarray.INDArray arr) throws Exception
		Public Overrides Function [call](ByVal arr As INDArray) As IList(Of Writable)
			If arr.rows() <> 1 Then
