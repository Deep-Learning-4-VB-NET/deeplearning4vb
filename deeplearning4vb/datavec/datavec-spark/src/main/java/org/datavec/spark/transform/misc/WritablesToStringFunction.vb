...
'ORIGINAL LINE: @AllArgsConstructor public class WritablesToStringFunction implements org.apache.spark.api.java.function.@Function<java.util.List<org.datavec.api.writable.Writable>, String>
...
'ORIGINAL LINE: @Override public String call(java.util.List<org.datavec.api.writable.Writable> c) throws Exception
		Public Overrides Function [call](ByVal c As IList(Of Writable)) As String
