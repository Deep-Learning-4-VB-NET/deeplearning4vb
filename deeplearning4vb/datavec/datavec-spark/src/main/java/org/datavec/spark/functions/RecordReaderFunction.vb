...
Namespace org.datavec.spark.functions
	...
	Public Class RecordReaderFunction
		Implements [Function](Of Tuple2(Of String, PortableDataStream), IList(Of Writable))
...
'ORIGINAL LINE: @Override public java.util.List<org.datavec.api.writable.Writable> call(scala.Tuple2<String, org.apache.spark.input.PortableDataStream> value) throws Exception
		Public Overrides Function [call](ByVal value As Tuple2(Of String, PortableDataStream)) As IList(Of Writable)
