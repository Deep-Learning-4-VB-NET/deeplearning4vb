...
'ORIGINAL LINE: @AllArgsConstructor public class HistogramAddFunction implements org.apache.spark.api.java.function.Function2<java.util.List<HistogramCounter>, java.util.List<org.datavec.api.writable.Writable>, java.util.List<HistogramCounter>>
	Public Class HistogramAddFunction
		Implements Function2(Of IList(Of HistogramCounter), IList(Of Writable), IList(Of HistogramCounter))
...
'ORIGINAL LINE: @Override public java.util.List<HistogramCounter> call(java.util.List<HistogramCounter> histogramCounters, java.util.List<org.datavec.api.writable.Writable> writables) throws Exception
		Public Overrides Function [call](ByVal histogramCounters As IList(Of HistogramCounter), ByVal writables As IList(Of Writable)) As IList(Of HistogramCounter)
