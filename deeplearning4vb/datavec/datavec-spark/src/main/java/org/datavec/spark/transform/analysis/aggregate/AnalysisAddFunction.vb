...
'ORIGINAL LINE: @AllArgsConstructor public class AnalysisAddFunction implements org.apache.spark.api.java.function.Function2<java.util.List<org.datavec.api.transform.analysis.AnalysisCounter>, java.util.List<org.datavec.api.writable.Writable>, java.util.List<org.datavec.api.transform.analysis.AnalysisCounter>>
	Public Class AnalysisAddFunction
		Implements Function2(Of IList(Of AnalysisCounter), IList(Of Writable), IList(Of AnalysisCounter))

		Private schema As Schema

'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: @Override public java.util.List<org.datavec.api.transform.analysis.AnalysisCounter> call(java.util.List<org.datavec.api.transform.analysis.AnalysisCounter> analysisCounters, java.util.List<org.datavec.api.writable.Writable> writables) throws Exception
		Public Overrides Function [call](ByVal analysisCounters As IList(Of AnalysisCounter), ByVal writables As IList(Of Writable)) As IList(Of AnalysisCounter)
			If analysisCounters Is Nothing Then
				...
				For Each ct As ColumnType In columnTypes
					Select Case ct.innerEnumValue
						...
						Case Double?, System.Nullable<Single>
