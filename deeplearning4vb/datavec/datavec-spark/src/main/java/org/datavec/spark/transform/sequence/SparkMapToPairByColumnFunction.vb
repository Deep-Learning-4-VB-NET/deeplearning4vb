...
'ORIGINAL LINE: @AllArgsConstructor public class SparkMapToPairByColumnFunction implements org.apache.spark.api.java.function.PairFunction<java.util.List<org.datavec.api.writable.Writable>, org.datavec.api.writable.Writable, java.util.List<org.datavec.api.writable.Writable>>
	Public Class SparkMapToPairByColumnFunction
		Implements PairFunction(Of IList(Of Writable), Writable, IList(Of Writable))

		Private ReadOnly keyColumnIdx As Integer
...
'ORIGINAL LINE: @Override public scala.Tuple2<org.datavec.api.writable.Writable, java.util.List<org.datavec.api.writable.Writable>> call(java.util.List<org.datavec.api.writable.Writable> writables) throws Exception
		Public Overrides Function [call](ByVal writables As IList(Of Writable)) As Tuple2(Of Writable, IList(Of Writable))
			Return New Tuple2(Of Writable, IList(Of Writable))(writables(keyColumnIdx), writables)
		End Function
	End Class
