...
Namespace org.deeplearning4j.rl4j.observation.transform
	...
	Public Class EncodableToINDArrayTransform
		Implements Operation(Of Encodable, INDArray)

		Public Overridable Function transform(ByVal encodable As Encodable) As INDArray
