...
Namespace org.deeplearning4j.rl4j.observation.transform.operation.historymerge
	...
	Public Interface HistoryMergeAssembler
		''' <summary>
		''' Assemble an array of INDArray into a single INArray </summary>
		''' <param name="elements"> The input INDArray[] </param>
		''' <returns> the assembled INDArray </returns>
		Function assemble(ByVal elements() As INDArray) As INDArray
	End Interface
