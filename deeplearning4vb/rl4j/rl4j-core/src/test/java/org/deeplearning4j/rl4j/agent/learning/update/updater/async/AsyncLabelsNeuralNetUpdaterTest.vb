...
'ORIGINAL LINE: @RunWith(MockitoJUnitRunner.class) @Tag(TagNames.FILE_IO) @NativeTag public class AsyncLabelsNeuralNetUpdaterTest
...
'ORIGINAL LINE: @Test public void when_callingUpdate_expect_handlerCalledAndThreadCurrentUpdated()
		Public Overridable Sub when_callingUpdate_expect_handlerCalledAndThreadCurrentUpdated()
			...
			Dim sut As New AsyncLabelsNeuralNetUpdater(threadCurrentMock, asyncSharedNetworksUpdateHandlerMock)
