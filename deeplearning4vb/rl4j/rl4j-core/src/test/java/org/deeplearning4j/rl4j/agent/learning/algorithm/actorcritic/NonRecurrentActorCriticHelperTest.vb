...
'ORIGINAL LINE: @Tag(TagNames.FILE_IO) @NativeTag public class NonRecurrentActorCriticHelperTest
	Public Class NonRecurrentActorCriticHelperTest

		Private ReadOnly sut As New NonRecurrentActorCriticHelper(3)
...
'ORIGINAL LINE: @Test public void when_callingSetPolicy_expect_advantageSetAtCorrectLocation()
		Public Overridable Sub when_callingSetPolicy_expect_advantageSetAtCorrectLocation()
			' Arrange
			Dim policyArray As INDArray = Nd4j.zeros(3, 3)
