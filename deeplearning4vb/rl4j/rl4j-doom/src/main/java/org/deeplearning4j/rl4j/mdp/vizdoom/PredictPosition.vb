...
Namespace org.deeplearning4j.rl4j.mdp.vizdoom
	...
	Public Class PredictPosition
		...
		Public Overrides ReadOnly Property Configuration As Configuration
			Get
				setScaleFactor(1.0)
				Dim buttons As IList(Of Button) = New List(Of Button) From {Button.TURN_LEFT, Button.TURN_RIGHT, Button.ATTACK}
				Return New Configuration("predict_position", -0.0001, 1, 0, 2100, 35, buttons)
			End Get
		End Property

		Public Overrides Function newInstance() As PredictPosition
