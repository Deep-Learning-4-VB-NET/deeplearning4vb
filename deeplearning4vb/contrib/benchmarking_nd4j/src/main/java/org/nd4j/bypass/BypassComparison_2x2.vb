...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Benchmark @BenchmarkMode(Mode.AverageTime) @OutputTimeUnit(java.util.concurrent.TimeUnit.NANOSECONDS) public void sgemm(SetupState state, org.openjdk.jmh.infra.Blackhole bh)
		Public Overridable Sub sgemm(ByVal state As SetupState, ByVal bh As Blackhole)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Benchmark @BenchmarkMode(Mode.AverageTime) @OutputTimeUnit(java.util.concurrent.TimeUnit.NANOSECONDS) public void cblas_gemm(SetupState state, org.openjdk.jmh.infra.Blackhole bh)
