...
Imports Nd4jCpu = org.nd4j.nativeblas.Nd4jCpu
...
'JAVA TO VB CONVERTER NOTE: The field INSTANCE was renamed since Visual Basic does not allow fields to have the same name as other class members:
		Private Shared ReadOnly INSTANCE_Conflict As New CpuEnvironment(Nd4jCpu.Environment.getInstance())

		Private ReadOnly e As Nd4jCpu.Environment

		Public Shared ReadOnly Property Instance As CpuEnvironment
			Get
				Return INSTANCE_Conflict
			End Get
		End Property

		Protected Friend Sub New(ByVal environment As Nd4jCpu.Environment)
			Me.e = environment
		End Sub
