...
Namespace org.nd4j.linalg.jcublas.rng
...
'ORIGINAL LINE: @Slf4j public class CudaNativeRandom extends org.nd4j.rng.NativeRandom
	Public Class CudaNativeRandom
		Inherits NativeRandom

		Private Shadows nativeOps As NativeOps
		Protected Friend stateBuffers As IList(Of DataBuffer)
		...
		Public Sub New(ByVal seed As Long, ByVal nodeSeed As Long)
			MyBase.New(seed, nodeSeed)
		End Sub
