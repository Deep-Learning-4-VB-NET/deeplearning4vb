...
'ORIGINAL LINE: @Override public void setInputArray(int index, @NonNull INDArray array)
		Public Overridable Overloads Sub setInputArray(ByVal index As Integer, ByVal array As INDArray)
			...
			nativeOps.setGraphContextInputBuffer(context, index,If(array.isEmpty(), Nothing, CType(array.data(), BaseCudaDataBuffer).OpaqueDataBuffer), array.shapeInfoDataBuffer().addressPointer(), AtomicAllocator.Instance.getPointer(array.shapeInfoDataBuffer()))
...
'ORIGINAL LINE: @Override public void setOutputArray(int index, @NonNull INDArray array)
		Public Overridable Overloads Sub setOutputArray(ByVal index As Integer, ByVal array As INDArray)
			...
			nativeOps.setGraphContextOutputBuffer(context, index,If(array.isEmpty(), Nothing, CType(array.data(), BaseCudaDataBuffer).OpaqueDataBuffer), array.shapeInfoDataBuffer().addressPointer(), AtomicAllocator.Instance.getPointer(array.shapeInfoDataBuffer()))
		...
		Public Overridable Sub setCudaStream(ByVal stream As cudaStream_t, ByVal reductionPointer As Pointer, ByVal allocationPointer As Pointer)
...
'ORIGINAL LINE: @Override public void setExecutionMode(@NonNull ExecutionMode mode)
		...
		Public Overridable Function deallocator() As Deallocator
			Return New CudaOpContextDeallocator(Me)
		End Function
