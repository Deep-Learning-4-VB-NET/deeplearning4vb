...
Namespace org.nd4j.linalg.jcublas.buffer
	...
	Public Class CudaIntDataBuffer
		...
		Public Sub New(ByVal length As Long, ByVal workspace As MemoryWorkspace)
			MyBase.New(length, 4, workspace)
		End Sub
		...
		Public Sub New(ByVal data() As Integer, ByVal workspace As MemoryWorkspace)
			Me.New(data.Length, workspace)
			setData(data)
		End Sub
