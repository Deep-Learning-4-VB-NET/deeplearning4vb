...
'ORIGINAL LINE: @Tag(TagNames.NDARRAY_ETL) @NativeTag @Tag(TagNames.FILE_IO) public class MultiNormalizerStandardizeTest extends org.nd4j.linalg.BaseNd4jTestWithBackends
	Public Class MultiNormalizerStandardizeTest
		...
		Private SUT As MultiNormalizerStandardize
		Private data As MultiDataSet
		Private meanNaturalNums As Double
		Private stdNaturalNums As Double
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @ParameterizedTest @MethodSource("org.nd4j.linalg.BaseNd4jTestWithBackends#configs") public void testFullyMaskedData(org.nd4j.linalg.factory.Nd4jBackend backend)
		Public Overridable Sub testFullyMaskedData(ByVal backend As Nd4jBackend)
		...
		Private Sub assertExpectedMeanStd()
