...
'ORIGINAL LINE: @Slf4j @NativeTag public class LapackTestsC extends org.nd4j.linalg.BaseNd4jTestWithBackends
	Public Class LapackTestsC
...
'ORIGINAL LINE: @ParameterizedTest @MethodSource("org.nd4j.linalg.BaseNd4jTestWithBackends#configs") public void testGetRF1DifferentOrders(org.nd4j.linalg.factory.Nd4jBackend backend)
		Public Overridable Sub testGetRF1DifferentOrders(ByVal backend As Nd4jBackend)
			Dim a As INDArray = Nd4j.linspace(1, 9, 9, Nd4j.dataType()).reshape(ChrW(3), 3)
			Dim exp As INDArray = Nd4j.create(New Double() {7.0, 8.0, 9.0, 0.14285715, 0.85714287, 1.7142857, 0.5714286, 0.5, 0.0}, New Integer() {3, 3}, "c"c)
