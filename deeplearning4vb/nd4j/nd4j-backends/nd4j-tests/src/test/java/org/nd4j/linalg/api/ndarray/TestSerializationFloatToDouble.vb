...
'ORIGINAL LINE: @NativeTag @Tag(TagNames.NDARRAY_SERDE) public class TestSerializationFloatToDouble extends org.nd4j.linalg.BaseNd4jTestWithBackends
	Public Class TestSerializationFloatToDouble
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		  Public Overridable Sub testSerializationFullArrayNd4jWriteRead(ByVal backend As Nd4jBackend)
			...
			Dim arr1 As INDArray = Nd4j.linspace(1, length, length, DataType.FLOAT).reshape("c"c, 10, 10)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @ParameterizedTest @MethodSource("org.nd4j.linalg.BaseNd4jTestWithBackends#configs") public void testSerializationFullArrayJava() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		  Public Overridable Sub testSerializationFullArrayJava()
			Dim length As Integer = 100
			Nd4j.create(1)
			DataTypeUtil.setDTypeForContext(DataType.FLOAT)
			Dim arr As INDArray = Nd4j.linspace(1, length, length).reshape("c"c, 10, 10)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @ParameterizedTest @MethodSource("org.nd4j.linalg.BaseNd4jTestWithBackends#configs") public void testSerializationOnViewsNd4jWriteRead() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		  Public Overridable Sub testSerializationOnViewsNd4jWriteRead()
			Dim length As Integer = 100
			Nd4j.create(1)
			DataTypeUtil.setDTypeForContext(DataType.FLOAT)
			Dim arr As INDArray = Nd4j.linspace(1, length, length).reshape("c"c, 10, 10)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @ParameterizedTest @MethodSource("org.nd4j.linalg.BaseNd4jTestWithBackends#configs") public void testSerializationOnViewsJava() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		  Public Overridable Sub testSerializationOnViewsJava()
			Dim length As Integer = 100
			Nd4j.create(1)
			DataTypeUtil.setDTypeForContext(DataType.FLOAT)
			Dim arr As INDArray = Nd4j.linspace(1, length, length).reshape("c"c, 10, 10)
