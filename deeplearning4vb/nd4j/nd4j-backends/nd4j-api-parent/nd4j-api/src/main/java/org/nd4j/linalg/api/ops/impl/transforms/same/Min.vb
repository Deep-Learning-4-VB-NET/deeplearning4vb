...
Namespace org.nd4j.linalg.api.ops.impl.transforms.same
	...
	Public Class Min
		...
		Public Overrides Function doDiff(ByVal f1 As IList(Of SDVariable)) As IList(Of SDVariable)
			'TODO optimize
			Dim gt As SDVariable = arg(0).gt(arg(1)).castTo(arg(0).dataType())
			Dim lt As SDVariable = arg(0).lt(arg(1)).castTo(arg(1).dataType())
			Return New List(Of SDVariable) From {lt.mul(f1(0)), gt.mul(f1(0))}
		End Function
