...
Imports ThresholdRelu = org.nd4j.linalg.api.ops.impl.transforms.custom.ThresholdRelu
...
Namespace org.nd4j.linalg.api.ops.impl.transforms.gradient
	...
	Public Class ThresholdReluBp
		Inherits DynamicCustomOp

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Getter private double cutoff = 0;
		Private cutoff As Double = 0

		Public Sub New()
		End Sub

		Public Sub New(ByVal sd As SameDiff, ByVal input As SDVariable, ByVal gradient As SDVariable, ByVal cutoff As Double)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public ThresholdReluBp(@NonNull INDArray input, @NonNull INDArray gradient, org.nd4j.linalg.api.ndarray.INDArray output, double cutoff)
