...
'ORIGINAL LINE: @Builder public ReluUniformInitScheme(char order, double fanIn)
		...
		Public Overrides Function doCreate(ByVal dataType As DataType, ByVal shape() As Long, ByVal paramsView As INDArray) As INDArray
			...
			Return Nd4j.rand(Nd4j.Distributions.createUniform(-u, u), shape) 'U(-sqrt(6/fanIn), sqrt(6/fanIn)
		End Function
