...
'ORIGINAL LINE: @NoArgsConstructor public class Swish extends org.nd4j.linalg.api.ops.BaseTransformStrictOp
	Public Class Swish
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Dim ret As SDVariable = (New SwishDerivative(sameDiff, arg())).outputVariable().mul(i_v(0))
