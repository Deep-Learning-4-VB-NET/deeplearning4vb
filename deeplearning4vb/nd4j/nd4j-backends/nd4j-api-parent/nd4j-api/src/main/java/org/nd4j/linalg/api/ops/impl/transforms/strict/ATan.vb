...
'ORIGINAL LINE: @NoArgsConstructor public class ATan extends org.nd4j.linalg.api.ops.BaseTransformStrictOp
	Public Class ATan
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			'd(atan(x))/dx = 1/(x^2+1)
			Dim xSqPlus1 As SDVariable = sameDiff.math_Conflict.square(arg()).add(1.0)
			Dim ret As SDVariable = xSqPlus1.rdiv(1.0).mul(i_v(0))
