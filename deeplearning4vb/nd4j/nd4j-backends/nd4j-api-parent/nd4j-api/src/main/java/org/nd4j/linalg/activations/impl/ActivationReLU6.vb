...
Imports Relu6 = org.nd4j.linalg.api.ops.impl.scalar.Relu6
...
'ORIGINAL LINE: @EqualsAndHashCode(callSuper = false) @Getter public class ActivationReLU6 extends org.nd4j.linalg.activations.BaseActivationFunction
	<Serializable>
	Public Class ActivationReLU6
		...
		Public Overrides Function getActivation(ByVal [in] As INDArray, ByVal training As Boolean) As INDArray
			Nd4j.Executioner.execAndReturn(New Relu6([in]))
			Return [in]
		End Function
		...
		Public Overrides Function backprop(ByVal [in] As INDArray, ByVal epsilon As INDArray) As Pair(Of INDArray, INDArray)
			...
			Nd4j.Executioner.execAndReturn(New Relu6Derivative([in], epsilon, [in]))
