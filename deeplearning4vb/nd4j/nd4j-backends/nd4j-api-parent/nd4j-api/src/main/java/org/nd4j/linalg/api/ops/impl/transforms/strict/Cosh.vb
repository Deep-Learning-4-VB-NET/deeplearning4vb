...
'ORIGINAL LINE: @NoArgsConstructor public class Cosh extends org.nd4j.linalg.api.ops.BaseTransformStrictOp
	Public Class Cosh
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Dim ret As SDVariable = sameDiff.math_Conflict.sinh(arg()).mul(i_v(0))
