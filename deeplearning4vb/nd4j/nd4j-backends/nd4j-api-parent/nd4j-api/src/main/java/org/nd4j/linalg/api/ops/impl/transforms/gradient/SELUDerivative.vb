...
Namespace org.nd4j.linalg.api.ops.impl.transforms.gradient
	...
	Public Class SELUDerivative
		...
		Private Const SELU_ALPHA As Double = 1.6732632423543772848170429916717
		Private Const SELU_LAMBDA As Double = 1.0507009873554804934193349852946
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Dim ret As SDVariable = sameDiff.math_Conflict.div(arg(), (New SELUDerivative(sameDiff, arg())).outputVariable())
