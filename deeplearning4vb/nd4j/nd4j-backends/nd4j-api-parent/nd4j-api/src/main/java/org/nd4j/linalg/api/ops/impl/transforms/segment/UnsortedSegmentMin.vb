...
Imports UnsortedSegmentMinBp = org.nd4j.linalg.api.ops.impl.transforms.segment.bp.UnsortedSegmentMinBp
...
'ORIGINAL LINE: @NoArgsConstructor public class UnsortedSegmentMin extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class UnsortedSegmentMin
		...
		Public Overrides Function doDiff(ByVal gradients As IList(Of SDVariable)) As IList(Of SDVariable)
			Return (New UnsortedSegmentMinBp(sameDiff, arg(0), arg(1), gradients(0), numSegments)).outputs()
		End Function
