...
Namespace org.nd4j.linalg.api.ops.impl.transforms.segment.bp
	...
	Public Class SegmentProdBp
		Inherits DynamicCustomOp

		Public Sub New(ByVal sameDiff As SameDiff, ByVal data As SDVariable, ByVal segmentIds As SDVariable, ByVal gradient As SDVariable)
