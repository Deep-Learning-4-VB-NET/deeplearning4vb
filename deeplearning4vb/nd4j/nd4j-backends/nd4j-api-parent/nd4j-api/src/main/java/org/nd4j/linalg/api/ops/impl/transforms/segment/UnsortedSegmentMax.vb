...
Imports UnsortedSegmentMaxBp = org.nd4j.linalg.api.ops.impl.transforms.segment.bp.UnsortedSegmentMaxBp
...
Namespace org.nd4j.linalg.api.ops.impl.transforms.segment
	...
	Public Class UnsortedSegmentMax
		Inherits DynamicCustomOp

		Protected Friend numSegments As Integer
		...
		Public Overrides Function doDiff(ByVal gradients As IList(Of SDVariable)) As IList(Of SDVariable)
			Return (New UnsortedSegmentMaxBp(sameDiff, arg(0), arg(1), gradients(0), numSegments)).outputs()
		End Function
