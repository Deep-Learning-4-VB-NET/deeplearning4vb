...
'ORIGINAL LINE: @NoArgsConstructor public class Igammac extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class Igammac
		Inherits DynamicCustomOp

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public Igammac(@NonNull INDArray n, @NonNull INDArray x)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public Igammac(@NonNull INDArray n, @NonNull INDArray x, org.nd4j.linalg.api.ndarray.INDArray output)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public Igammac(@NonNull SameDiff sameDiff, @NonNull SDVariable n, @NonNull SDVariable x)
