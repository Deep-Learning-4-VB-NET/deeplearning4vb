...
Imports HuberLossBp = org.nd4j.linalg.api.ops.impl.loss.bp.HuberLossBp
...
Namespace org.nd4j.linalg.api.ops.impl.loss
	...
	Public Class HuberLoss
		...
		Public Sub New(ByVal sameDiff As SameDiff, ByVal labels As SDVariable, ByVal predictions As SDVariable, ByVal weights As SDVariable, ByVal lossReduce As LossReduce, ByVal delta As Double)
			Me.New(sameDiff, lossReduce, predictions, weights, labels, delta)
		End Sub

		Public Sub New(ByVal labels As INDArray, ByVal predictions As INDArray, ByVal weights As INDArray, ByVal lossReduce As LossReduce, ByVal delta As Double)
