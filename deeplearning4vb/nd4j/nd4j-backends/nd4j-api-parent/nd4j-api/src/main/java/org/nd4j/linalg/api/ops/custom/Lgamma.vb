...
'ORIGINAL LINE: @NoArgsConstructor public class Lgamma extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class Lgamma
		Inherits DynamicCustomOp

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public Lgamma(@NonNull INDArray x)
		Public Sub New(ByVal x As INDArray)
			addInputArgument(x)
		End Sub

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public Lgamma(@NonNull INDArray x, org.nd4j.linalg.api.ndarray.INDArray output)
		Public Sub New(ByVal x As INDArray, ByVal output As INDArray)
			Me.New(x)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public Lgamma(@NonNull SameDiff sameDiff, @NonNull SDVariable x)
