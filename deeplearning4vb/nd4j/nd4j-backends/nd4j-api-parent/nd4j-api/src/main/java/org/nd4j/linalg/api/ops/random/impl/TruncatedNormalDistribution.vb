...
Namespace org.nd4j.linalg.api.ops.random.impl
	...
	Public Class TruncatedNormalDistribution
		...
		Public Sub New(ByVal sd As SameDiff, ByVal mean As Double, ByVal stddev As Double, ByVal shape() As Long)
			MyBase.New(sd, shape)
			Me.mean = mean
			Me.stddev = stddev
		...
		Public Sub New(ByVal sd As SameDiff, ByVal mean As Double, ByVal stddev As Double, ByVal dataType As DataType, ByVal shape() As Long)
			MyBase.New(sd, shape)
			Me.mean = mean
			Me.stddev = stddev
			Me.extraArgs = New Object() {Me.mean, Me.stddev}
...
'ORIGINAL LINE: public TruncatedNormalDistribution(@NonNull INDArray z, double mean, double stddev)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public TruncatedNormalDistribution(@NonNull INDArray z, @NonNull INDArray means, double stddev)
		...
		''' <param name="z"> </param>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public TruncatedNormalDistribution(@NonNull INDArray z)
		...
		''' <param name="z"> </param>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public TruncatedNormalDistribution(@NonNull INDArray z, double stddev)
