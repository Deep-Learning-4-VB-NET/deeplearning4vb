...
'ORIGINAL LINE: @Builder public VarScalingNormalUniformFanInInitScheme(char order, double fanIn)
		...
		Public Overrides Function doCreate(ByVal dataType As DataType, ByVal shape() As Long, ByVal paramsView As INDArray) As INDArray
			...
			Return Nd4j.rand(Nd4j.Distributions.createUniform(-scalingFanIn, scalingFanIn), shape)
		End Function
