...
'ORIGINAL LINE: public ScatterMul(@NonNull INDArray ref, @NonNull INDArray indices, @NonNull INDArray update)
		...
		Public Overrides Function doDiff(ByVal gradOut As IList(Of SDVariable)) As IList(Of SDVariable)
			...
			Dim gradRef As SDVariable = sameDiff.scatterMul(gradOut(0), indices, updates)
			...
			Dim updateGrad As SDVariable = gatherOutGrad.mul(gatherRef)
			ret.Add(updateGrad)
