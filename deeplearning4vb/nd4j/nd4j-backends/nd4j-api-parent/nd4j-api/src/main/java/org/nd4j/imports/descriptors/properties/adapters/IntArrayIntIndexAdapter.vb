...
'ORIGINAL LINE: @AllArgsConstructor public class IntArrayIntIndexAdapter implements org.nd4j.imports.descriptors.properties.AttributeAdapter
	Public Class IntArrayIntIndexAdapter
