...
Namespace org.nd4j.linalg.api.ops.impl.shape.tensorops
	...
	Public Class TensorArrayConcat
		...
		Public Overrides Function calculateOutputDataTypes(ByVal inputDataType As IList(Of DataType)) As IList(Of DataType)
			...
			Dim tArr As SDVariable = arg(0)
			Dim t3 As TensorArray = DirectCast(sameDiff.getVariableOutputOp(tArr.name()), TensorArray)
			Dim dt As DataType = t3.getTensorArrayDataType()
