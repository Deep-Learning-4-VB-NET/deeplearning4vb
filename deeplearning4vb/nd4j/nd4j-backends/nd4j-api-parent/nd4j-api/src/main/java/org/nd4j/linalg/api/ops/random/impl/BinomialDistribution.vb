...
Namespace org.nd4j.linalg.api.ops.random.impl
	...
	Public Class BinomialDistribution
		...
		Public Sub New(ByVal sd As SameDiff, ByVal trials As Integer, ByVal probability As Double, ByVal shape() As Long)
			MyBase.New(sd, shape)
			Me.trials = trials
		...
		Public Sub New(ByVal sd As SameDiff, ByVal trials As Integer, ByVal probability As Double, ByVal dataType As DataType, ByVal shape() As Long)
			Me.New(sd, trials, probability, shape)
			MyBase.dataType = dataType
		End Sub

		Public Sub New(ByVal trials As Integer, ByVal probability As Double, ByVal dt As DataType, ByVal shape() As Long)
			Me.New(Nd4j.createUninitialized(dt, shape), trials, probability)
		End Sub
...
'ORIGINAL LINE: public BinomialDistribution(@NonNull INDArray z, int trials, double probability)
		Public Sub New(ByVal z As INDArray, ByVal trials As Integer, ByVal probability As Double)
			MyBase.New(z, z, z)
			Me.trials = trials
			Me.probability = probability
			Me.extraArgs = New Object() {CDbl(Me.trials), Me.probability}
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public BinomialDistribution(@NonNull INDArray z, int trials, @NonNull INDArray probabilities)
		Public Sub New(ByVal z As INDArray, ByVal trials As Integer, ByVal probabilities As INDArray)
			MyBase.New(z, probabilities, z)
			If trials > probabilities.length() Then
				Throw New System.InvalidOperationException("Number of trials is > then amount of probabilities provided")
			End If
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public BinomialDistribution(@NonNull INDArray z, @NonNull INDArray probabilities)
		Public Sub New(ByVal z As INDArray, ByVal probabilities As INDArray)
			Me.New(z, CInt(probabilities.length()), probabilities)
		End Sub
