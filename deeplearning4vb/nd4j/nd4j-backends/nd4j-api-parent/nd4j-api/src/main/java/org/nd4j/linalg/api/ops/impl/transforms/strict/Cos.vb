...
'ORIGINAL LINE: @NoArgsConstructor public class Cos extends org.nd4j.linalg.api.ops.BaseTransformStrictOp
	Public Class Cos
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Dim ret As SDVariable = sameDiff.math_Conflict.neg(sameDiff.math_Conflict.sin(arg())).mul(i_v(0))
