...
Imports UnsortedSegmentSqrtNBp = org.nd4j.linalg.api.ops.impl.transforms.segment.bp.UnsortedSegmentSqrtNBp
...
'ORIGINAL LINE: @NoArgsConstructor public class UnsortedSegmentSqrtN extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class UnsortedSegmentSqrtN
		...
		Public Overrides Function doDiff(ByVal gradients As IList(Of SDVariable)) As IList(Of SDVariable)
			Return (New UnsortedSegmentSqrtNBp(sameDiff, arg(0), arg(1), gradients(0), numSegments)).outputs()
		End Function
