...
'ORIGINAL LINE: public ToggleBits(@NonNull INDArray input, org.nd4j.linalg.api.ndarray.INDArray output)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public ToggleBits(@NonNull INDArray input)
		Public Sub New(ByVal input As INDArray)
			addInputArgument(input)
		End Sub

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public ToggleBits(@NonNull SameDiff sameDiff, @NonNull SDVariable input)
