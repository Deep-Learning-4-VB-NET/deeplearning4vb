...
Namespace org.nd4j.linalg.api.ops.impl.reduce.same
	...
	Public Class AMin
		...
		Public Overrides ReadOnly Property FinalResult As Number
			Get
				Return Nothing
			End Get
		End Property
		...
		Public Overrides Function doDiff(ByVal f1 As IList(Of SDVariable)) As IList(Of SDVariable)
			...
			Dim minBp As SDVariable = (New MinBp(sameDiff, sameDiff.math().abs(arg()), f1(0), False, dimensions)).outputVariable()
