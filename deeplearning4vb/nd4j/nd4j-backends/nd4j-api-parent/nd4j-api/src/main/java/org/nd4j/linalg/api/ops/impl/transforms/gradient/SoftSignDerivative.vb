...
'ORIGINAL LINE: @Deprecated @NoArgsConstructor public class SoftSignDerivative extends org.nd4j.linalg.api.ops.BaseTransformStrictOp
	<Obsolete>
	Public Class SoftSignDerivative
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Dim ret As SDVariable = sameDiff.zerosLike(arg())
