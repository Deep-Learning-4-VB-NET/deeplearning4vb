...
Imports UnsortedSegmentSumBp = org.nd4j.linalg.api.ops.impl.transforms.segment.bp.UnsortedSegmentSumBp
...
'ORIGINAL LINE: @NoArgsConstructor public class UnsortedSegmentSum extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class UnsortedSegmentSum
		...
		Public Overrides Function doDiff(ByVal gradients As IList(Of SDVariable)) As IList(Of SDVariable)
			Return (New UnsortedSegmentSumBp(sameDiff, arg(0), arg(1), gradients(0), numSegments)).outputs()
		End Function
