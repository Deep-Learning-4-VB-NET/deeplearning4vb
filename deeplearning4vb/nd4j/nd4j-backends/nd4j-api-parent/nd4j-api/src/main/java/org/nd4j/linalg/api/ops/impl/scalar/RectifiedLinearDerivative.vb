...
Namespace org.nd4j.linalg.api.ops.impl.scalar
	...
	Public Class RectifiedLinearDerivative
...
'ORIGINAL LINE: public RectifiedLinearDerivative(@NonNull INDArray input, @NonNull INDArray gradient, org.nd4j.linalg.api.ndarray.INDArray output)
		Public Sub New(ByVal input As INDArray, ByVal gradient As INDArray, ByVal output As INDArray)
			Me.New(input, gradient, output, 0.0)
		End Sub

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public RectifiedLinearDerivative(@NonNull INDArray input, @NonNull INDArray gradient, org.nd4j.linalg.api.ndarray.INDArray output, double scalar)
		Public Sub New(ByVal input As INDArray, ByVal gradient As INDArray, ByVal output As INDArray, ByVal scalar As Double)
