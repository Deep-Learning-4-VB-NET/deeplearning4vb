...
Imports FloorDivBpOp = org.nd4j.linalg.api.ops.impl.transforms.pairwise.arithmetic.bp.FloorDivBpOp
...
'ORIGINAL LINE: public FloorDivOp(@NonNull INDArray x, @NonNull INDArray y)
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Return (New FloorDivBpOp(sameDiff, larg(), rarg(), i_v(0))).outputs()
		End Function
	End Class
