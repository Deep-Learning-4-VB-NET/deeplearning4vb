...
'ORIGINAL LINE: @NoArgsConstructor public class Expm1 extends org.nd4j.linalg.api.ops.BaseTransformStrictOp
	Public Class Expm1
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Dim ret As SDVariable = sameDiff.math_Conflict.mul(sameDiff.math_Conflict.exp(arg()), i_v(0))
