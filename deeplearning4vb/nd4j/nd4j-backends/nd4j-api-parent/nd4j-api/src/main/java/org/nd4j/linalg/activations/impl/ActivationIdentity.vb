...
'ORIGINAL LINE: @EqualsAndHashCode(callSuper = false) @Getter public class ActivationIdentity extends org.nd4j.linalg.activations.BaseActivationFunction
	<Serializable>
	Public Class ActivationIdentity
		...
		Public Overrides Function backprop(ByVal [in] As INDArray, ByVal epsilon As INDArray) As Pair(Of INDArray, INDArray)
			...
			Return New Pair(Of INDArray, INDArray)(epsilon, Nothing)
		End Function
