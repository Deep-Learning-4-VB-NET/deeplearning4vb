...
Namespace org.nd4j.linalg.api.ops.impl.scalar.comparison
	...
	Public Class ScalarLessThan
		...
		Public Sub New(ByVal sameDiff As SameDiff, ByVal i_v As SDVariable, ByVal scalar As Double)
			MyBase.New(sameDiff, i_v, scalar, False)
		End Sub
