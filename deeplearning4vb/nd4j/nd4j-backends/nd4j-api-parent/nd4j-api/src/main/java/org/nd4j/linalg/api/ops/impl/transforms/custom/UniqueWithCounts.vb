...
'ORIGINAL LINE: @Slf4j public class UniqueWithCounts extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class UniqueWithCounts
		...
		Public Overrides Function calculateOutputDataTypes(ByVal dataTypes As IList(Of DataType)) As IList(Of DataType)
			...
			End If
			Dim d As DataType = (If(idxDataType = Nothing, DEFAULT_IDX_DTYPE, idxDataType))
			Return New List(Of DataType) From {dataTypes(0), d, d}
		End Function
	End Class
