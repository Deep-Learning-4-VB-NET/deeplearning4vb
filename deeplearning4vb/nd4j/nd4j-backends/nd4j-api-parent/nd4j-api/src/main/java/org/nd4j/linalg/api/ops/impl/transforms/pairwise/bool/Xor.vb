...
'ORIGINAL LINE: public @Xor(@NonNull INDArray x, @NonNull INDArray y)
		Public Sub New(ByVal x As INDArray, ByVal y As INDArray)
			Me.New(x, y, x, 0.0)
		End Sub

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public @Xor(@NonNull INDArray x, @NonNull INDArray y, org.nd4j.linalg.api.ndarray.INDArray z)
		Public Sub New(ByVal x As INDArray, ByVal y As INDArray, ByVal z As INDArray)
			Me.New(x, y, z, 0.0)
		End Sub

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public @Xor(@NonNull INDArray x, @NonNull INDArray y, org.nd4j.linalg.api.ndarray.INDArray z, Number comparable)
