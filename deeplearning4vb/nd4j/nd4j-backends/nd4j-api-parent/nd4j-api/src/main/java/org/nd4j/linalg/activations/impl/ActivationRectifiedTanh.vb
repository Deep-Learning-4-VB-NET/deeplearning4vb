...
Imports RectifiedTanhBp = org.nd4j.linalg.api.ops.impl.transforms.gradient.RectifiedTanhBp
...
'ORIGINAL LINE: @EqualsAndHashCode(callSuper = false) @Getter public class ActivationRectifiedTanh extends org.nd4j.linalg.activations.BaseActivationFunction
	<Serializable>
	Public Class ActivationRectifiedTanh
		...
		Public Overrides Function getActivation(ByVal [in] As INDArray, ByVal training As Boolean) As INDArray
			Nd4j.Executioner.execAndReturn(New RectifiedTanh([in]))
			Return [in]
		End Function
		...
		Public Overrides Function backprop(ByVal [in] As INDArray, ByVal epsilon As INDArray) As Pair(Of INDArray, INDArray)
			...
			Nd4j.Executioner.execAndReturn(New RectifiedTanhBp([in], epsilon, [in]))
