...
'ORIGINAL LINE: public IsStrictlyIncreasing(@NonNull INDArray input)
		Public Sub New(ByVal input As INDArray)
			Me.New(input, Nothing)
		End Sub

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public IsStrictlyIncreasing(@NonNull INDArray input, org.nd4j.linalg.api.ndarray.INDArray output)
