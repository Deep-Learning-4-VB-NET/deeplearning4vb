...
'ORIGINAL LINE: @AllArgsConstructor public class ConditionalFieldValueNDArrayShapeAdapter implements org.nd4j.imports.descriptors.properties.AttributeAdapter
	Public Class ConditionalFieldValueNDArrayShapeAdapter
		...
		Public Overridable Sub mapAttributeFor(ByVal inputAttributeValue As Object, ByVal fieldFor As System.Reflection.FieldInfo, ByVal [on] As DifferentialFunction) Implements AttributeAdapter.mapAttributeFor
			Dim inputValue As INDArray = DirectCast(inputAttributeValue, INDArray)
			Dim compProperty As Object = [on].getValue(fieldName)
			If targetValue.Equals(compProperty) Then
