...
Namespace org.nd4j.linalg.api.ops.impl.transforms.clip
	...
	Public Class ClipByNormBp
		...
		Public Sub New(ByVal sameDiff As SameDiff, ByVal x As SDVariable, ByVal eps As SDVariable, ByVal clipValue As Double, ParamArray ByVal dimensions() As Integer)
			MyBase.New(Nothing, sameDiff, New SDVariable(){x, eps})
