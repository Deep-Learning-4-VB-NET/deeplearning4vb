...
Imports MulBpOp = org.nd4j.linalg.api.ops.impl.transforms.pairwise.arithmetic.bp.MulBpOp
...
Namespace org.nd4j.linalg.api.ops.impl.transforms.pairwise.arithmetic
	...
	Public Class MulOp
		...
		Public Const OP_NAME As String = "multiply"

		Public Sub New()
		End Sub

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public MulOp(@NonNull SameDiff sameDiff, @NonNull SDVariable x, @NonNull SDVariable y)
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Return (New MulBpOp(sameDiff, larg(), rarg(), i_v(0))).outputs()
		End Function
