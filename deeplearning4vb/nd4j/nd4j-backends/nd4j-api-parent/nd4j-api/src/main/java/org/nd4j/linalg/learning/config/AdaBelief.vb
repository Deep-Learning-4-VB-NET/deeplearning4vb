...
Imports AdaBeliefUpdater = org.nd4j.linalg.learning.AdaBeliefUpdater
...
'ORIGINAL LINE: @Data @Builder(builderClassName = "Builder") public class AdaBelief implements IUpdater
	<Serializable>
	Public Class AdaBelief
		Implements IUpdater

		Public Const DEFAULT_LEARNING_RATE As Double = 1e-3
		Public Const DEFAULT_EPSILON As Double = 1e-14
		Public Const DEFAULT_BETA1_MEAN_DECAY As Double = 0.9
		Public Const DEFAULT_BETA2_VAR_DECAY As Double = 0.999

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @lombok.Builder.@Default private double learningRate = DEFAULT_LEARNING_RATE;
		Private learningRate As Double = DEFAULT_LEARNING_RATE ' learning rate
		Private learningRateSchedule As ISchedule
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @lombok.Builder.@Default private double beta1 = DEFAULT_BETA1_MEAN_DECAY;
		Private beta1 As Double = DEFAULT_BETA1_MEAN_DECAY ' gradient moving avg decay rate
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @lombok.Builder.@Default private double beta2 = DEFAULT_BETA2_VAR_DECAY;
		Private beta2 As Double = DEFAULT_BETA2_VAR_DECAY ' gradient sqrt decay rate
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @lombok.Builder.@Default private double epsilon = DEFAULT_EPSILON;
		Private epsilon As Double = DEFAULT_EPSILON

		Public Sub New()
			Me.New(DEFAULT_LEARNING_RATE, DEFAULT_BETA1_MEAN_DECAY, DEFAULT_BETA2_VAR_DECAY, DEFAULT_EPSILON)
		End Sub

		Public Sub New(ByVal learningRate As Double)
			Me.New(learningRate, Nothing, DEFAULT_BETA1_MEAN_DECAY, DEFAULT_BETA2_VAR_DECAY, DEFAULT_EPSILON)
		End Sub

		Public Sub New(ByVal learningRateSchedule As ISchedule)
			Me.New(Double.NaN, learningRateSchedule, DEFAULT_BETA1_MEAN_DECAY, DEFAULT_BETA2_VAR_DECAY, DEFAULT_EPSILON)
		End Sub
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: private AdaBelief(@JsonProperty("learningRate") double learningRate, @JsonProperty("learningRateSchedule") org.nd4j.linalg.schedule.ISchedule learningRateSchedule, @JsonProperty("beta1") double beta1, @JsonProperty("beta2") double beta2, @JsonProperty("epsilon") double epsilon)
		...
		Public Overridable Function instantiate(ByVal viewArray As INDArray, ByVal initializeViewArray As Boolean) As GradientUpdater Implements IUpdater.instantiate
			Dim u As New AdaBeliefUpdater(Me)
		...
		Public Overridable Function clone() As AdaBelief
