...
Imports RDivBpOp = org.nd4j.linalg.api.ops.impl.transforms.pairwise.arithmetic.bp.RDivBpOp
...
Namespace org.nd4j.linalg.api.ops.impl.transforms.pairwise.arithmetic
	...
	Public Class RDivOp
		...
		Public Const OP_NAME As String = "reversedivide"

		Public Sub New()
		End Sub

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public RDivOp(@NonNull SameDiff sameDiff, @NonNull SDVariable x, @NonNull SDVariable y)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public RDivOp(@NonNull INDArray x, @NonNull INDArray y)
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Return New List(Of SDVariable) From {(New RDivBpOp(sameDiff, larg(), rarg(), i_v(0))).outputVariables()}
		End Function
	End Class
