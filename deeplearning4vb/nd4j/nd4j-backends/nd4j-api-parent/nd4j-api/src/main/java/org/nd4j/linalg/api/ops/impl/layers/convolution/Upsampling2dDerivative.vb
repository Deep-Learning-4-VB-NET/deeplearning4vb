...
'ORIGINAL LINE: @Slf4j public class Upsampling2dDerivative extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class Upsampling2dDerivative
		...
		Public Sub New(ByVal sameDiff As SameDiff, ByVal input As SDVariable, ByVal gradient As SDVariable, ByVal nchw As Boolean, ByVal scaleH As Integer, ByVal scaleW As Integer)
