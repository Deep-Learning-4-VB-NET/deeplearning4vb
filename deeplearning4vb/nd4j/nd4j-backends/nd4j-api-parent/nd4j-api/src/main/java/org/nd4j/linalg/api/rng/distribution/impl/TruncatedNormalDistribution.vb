...
'ORIGINAL LINE: public TruncatedNormalDistribution(double mean, double sd) throws org.apache.commons.math3.exception.NotStrictlyPositiveException
		Public Sub New(ByVal mean As Double, ByVal sd As Double)
			Me.New(mean, sd, DEFAULT_INVERSE_ABSOLUTE_ACCURACY)
		End Sub

'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: public TruncatedNormalDistribution(org.nd4j.linalg.api.rng.Random rng, double mean, double sd) throws org.apache.commons.math3.exception.NotStrictlyPositiveException
		...
		''' @since 2.1 </exception>
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: public TruncatedNormalDistribution(double mean, double sd, double inverseCumAccuracy) throws org.apache.commons.math3.exception.NotStrictlyPositiveException
		...
		''' @since 3.1 </exception>
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: public TruncatedNormalDistribution(org.nd4j.linalg.api.rng.Random rng, double mean, double sd, double inverseCumAccuracy) throws org.apache.commons.math3.exception.NotStrictlyPositiveException
...
'ORIGINAL LINE: final org.nd4j.linalg.api.ndarray.INDArray ret = org.nd4j.linalg.factory.Nd4j.createUninitialized(shape, org.nd4j.linalg.factory.Nd4j.order());
		...
		Public Overrides Function sample(ByVal ret As INDArray) As INDArray
			If means IsNot Nothing Then
				Return Nd4j.Executioner.exec(New org.nd4j.linalg.api.ops.random.impl.TruncatedNormalDistribution(ret, means, standardDeviation_Conflict), random)
			Else
				Return Nd4j.Executioner.exec(New org.nd4j.linalg.api.ops.random.impl.TruncatedNormalDistribution(ret, mean_Conflict, standardDeviation_Conflict), random)
			End If
		End Function
	End Class
