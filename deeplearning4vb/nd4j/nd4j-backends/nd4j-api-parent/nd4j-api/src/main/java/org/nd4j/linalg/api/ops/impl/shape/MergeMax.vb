...
Imports MergeMaxBp = org.nd4j.linalg.api.ops.impl.shape.bp.MergeMaxBp
...
'ORIGINAL LINE: @Slf4j public class MergeMax extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class MergeMax
	...
	'
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Return New List(Of SDVariable) From {(New MergeMaxBp(sameDiff, args(), i_v(0))).outputVariables()}
