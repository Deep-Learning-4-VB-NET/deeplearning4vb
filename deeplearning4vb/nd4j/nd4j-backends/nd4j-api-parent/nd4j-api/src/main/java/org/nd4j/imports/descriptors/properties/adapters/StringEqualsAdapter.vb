...
'ORIGINAL LINE: @AllArgsConstructor public class StringEqualsAdapter implements org.nd4j.imports.descriptors.properties.AttributeAdapter
	Public Class StringEqualsAdapter
		...
		Public Overridable Sub mapAttributeFor(ByVal inputAttributeValue As Object, ByVal fieldFor As System.Reflection.FieldInfo, ByVal [on] As DifferentialFunction) Implements AttributeAdapter.mapAttributeFor
			Dim b As val = inputAttributeValue.ToString().Equals(compString)
