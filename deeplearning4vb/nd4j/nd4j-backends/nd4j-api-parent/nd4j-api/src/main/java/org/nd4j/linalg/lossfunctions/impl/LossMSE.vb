...
'ORIGINAL LINE: @EqualsAndHashCode(callSuper = true) public class LossMSE extends LossL2
	<Serializable>
	Public Class LossMSE
		Inherits LossL2
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public LossMSE(@JsonProperty("weights") org.nd4j.linalg.api.ndarray.INDArray weights)
