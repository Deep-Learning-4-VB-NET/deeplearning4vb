...
Imports NadamUpdater = org.nd4j.linalg.learning.NadamUpdater
...
'ORIGINAL LINE: @Data @Builder(builderClassName = "Builder") public class Nadam implements IUpdater
	<Serializable>
	Public Class Nadam
		Implements IUpdater

		Public Const DEFAULT_NADAM_LEARNING_RATE As Double = 1e-3
		Public Const DEFAULT_NADAM_EPSILON As Double = 1e-8
		Public Const DEFAULT_NADAM_BETA1_MEAN_DECAY As Double = 0.9
		Public Const DEFAULT_NADAM_BETA2_VAR_DECAY As Double = 0.999

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @lombok.Builder.@Default private double learningRate = 1e-3;
		Private learningRate As Double = 1e-3 ' learning rate
		Private learningRateSchedule As ISchedule
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @lombok.Builder.@Default private double beta1 = DEFAULT_NADAM_BETA1_MEAN_DECAY;
		Private beta1 As Double = DEFAULT_NADAM_BETA1_MEAN_DECAY ' gradient moving avg decay rate
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @lombok.Builder.@Default private double beta2 = DEFAULT_NADAM_BETA2_VAR_DECAY;
		Private beta2 As Double = DEFAULT_NADAM_BETA2_VAR_DECAY ' gradient sqrd decay rate
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @lombok.Builder.@Default private double epsilon = DEFAULT_NADAM_EPSILON;
		Private epsilon As Double = DEFAULT_NADAM_EPSILON

		Public Sub New()
			Me.New(DEFAULT_NADAM_LEARNING_RATE, DEFAULT_NADAM_BETA1_MEAN_DECAY, DEFAULT_NADAM_BETA2_VAR_DECAY, DEFAULT_NADAM_EPSILON)
		End Sub

		Public Sub New(ByVal learningRate As Double)
			Me.New(learningRate, Nothing, DEFAULT_NADAM_BETA1_MEAN_DECAY, DEFAULT_NADAM_BETA2_VAR_DECAY, DEFAULT_NADAM_EPSILON)
		End Sub

		Public Sub New(ByVal learningRateSchedule As ISchedule)
			Me.New(Double.NaN, learningRateSchedule, DEFAULT_NADAM_BETA1_MEAN_DECAY, DEFAULT_NADAM_BETA2_VAR_DECAY, DEFAULT_NADAM_EPSILON)
		End Sub
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: private Nadam(@JsonProperty("learningRate") double learningRate, @JsonProperty("learningRateSchedule") org.nd4j.linalg.schedule.ISchedule learningRateSchedule, @JsonProperty("beta1") double beta1, @JsonProperty("beta2") double beta2, @JsonProperty("epsilon") double epsilon)
		...
		Public Overridable Function clone() As Nadam
