...
'ORIGINAL LINE: @Builder(builderMethodName = "builder") public Im2col(org.nd4j.autodiff.samediff.SameDiff sameDiff, org.nd4j.autodiff.samediff.SDVariable[] inputFunctions, org.nd4j.linalg.api.ndarray.INDArray[] inputArrays, org.nd4j.linalg.api.ndarray.INDArray[] outputs, org.nd4j.linalg.api.ops.impl.layers.convolution.config.Conv2DConfig conv2DConfig)
		...
		Public Sub New(ByVal [in] As INDArray, ByVal conv2DConfig As Conv2DConfig)
			MyBase.New("im2Col",[in],Nothing,Nothing,Nothing)
			Me.conv2DConfig = conv2DConfig
			addArgs()
		End Sub
		...
		Public Overrides Function doDiff(ByVal grad As IList(Of SDVariable)) As IList(Of SDVariable)
			Return (New Im2colBp(sameDiff, arg(), grad(0), conv2DConfig)).outputs()
		End Function
