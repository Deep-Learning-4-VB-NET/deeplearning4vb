...
'ORIGINAL LINE: @NoArgsConstructor public class CReLU extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class CReLU
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public CReLU(@NonNull INDArray input)
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			...
			Return Collections.singletonList((New CReluBp(sameDiff, arg(), i_v(0))).outputVariable())
		End Function
