...
'ORIGINAL LINE: @NoArgsConstructor public class Igamma extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class Igamma
		Inherits DynamicCustomOp

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public Igamma(@NonNull INDArray n, @NonNull INDArray x)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public Igamma(@NonNull INDArray n, @NonNull INDArray x, org.nd4j.linalg.api.ndarray.INDArray output)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public Igamma(@NonNull SameDiff sameDiff, @NonNull SDVariable n, @NonNull SDVariable x)
