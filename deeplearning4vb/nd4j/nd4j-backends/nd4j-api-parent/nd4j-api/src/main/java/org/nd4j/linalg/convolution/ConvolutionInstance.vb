...
Namespace org.nd4j.linalg.convolution
	...
	Public Interface ConvolutionInstance
		...
		''' <param name="type">
		''' @return </param>
		Function conv2d(ByVal input As INDArray, ByVal kernel As INDArray, ByVal type As Convolution.Type) As INDArray
		...
		Function convn(ByVal input As INDArray, ByVal kernel As INDArray, ByVal type As Convolution.Type, ByVal axes() As Integer) As INDArray
		...
		''' <param name="type">   the opType of convolution </param>
		''' <returns> the convolution of the given input and kernel </returns>
		Function convn(ByVal input As INDArray, ByVal kernel As INDArray, ByVal type As Convolution.Type) As INDArray
	End Interface
