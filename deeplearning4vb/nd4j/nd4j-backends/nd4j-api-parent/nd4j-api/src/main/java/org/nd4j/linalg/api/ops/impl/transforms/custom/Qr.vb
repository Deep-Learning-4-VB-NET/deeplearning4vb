...
'ORIGINAL LINE: @NoArgsConstructor public class Qr extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class Qr
		...
		Public Sub New(ByVal input As INDArray)
			Me.New(input, False)
		End Sub
		Public Sub New(ByVal input As INDArray, ByVal fullMatrices As Boolean)
			addInputArgument(input)
			addBArgument(fullMatrices)
		End Sub

		Public Sub New(ByVal sameDiff As SameDiff, ByVal input As SDVariable, ByVal fullMatrices As Boolean)
