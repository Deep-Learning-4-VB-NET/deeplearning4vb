...
'ORIGINAL LINE: @NoArgsConstructor public class HardTanh extends org.nd4j.linalg.api.ops.BaseTransformStrictOp
	Public Class HardTanh
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Return (New HardTanhBp(sameDiff, arg(), i_v(0))).outputs()
		End Function
	End Class
