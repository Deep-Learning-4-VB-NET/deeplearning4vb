...
'ORIGINAL LINE: public ScatterAdd(@NonNull INDArray ref, @NonNull INDArray indices, @NonNull INDArray update)
		...
		Public Overrides Function doDiff(ByVal gradOut As IList(Of SDVariable)) As IList(Of SDVariable)
			...
			ret.Add(gradOut(0)) 'Reference array
			ret.Add(sameDiff.zerosLike(arg(1))) 'Indices

			Dim gather As SDVariable = sameDiff.gather(gradOut(0), arg(1), 0) 'Updates
			ret.Add(gather)
