...
'ORIGINAL LINE: @NoArgsConstructor public class MergeAvgBp extends org.nd4j.linalg.api.ops.DynamicCustomOp
	Public Class MergeAvgBp
		Inherits DynamicCustomOp

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public MergeAvgBp(org.nd4j.autodiff.samediff.SameDiff sameDiff, @NonNull SDVariable[] inputs, @NonNull SDVariable gradO)
		Public Sub New(ByVal sameDiff As SameDiff, ByVal inputs() As SDVariable, ByVal gradO As SDVariable)
			MyBase.New("mergeavg_bp", sameDiff, ArrayUtils.add(inputs, gradO))
		End Sub
