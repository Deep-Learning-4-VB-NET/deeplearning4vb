...
Namespace org.nd4j.linalg.api.ops.impl.reduce.floating
	...
	Public Class LogEntropy
		...
		Public Overrides Function doDiff(ByVal f1 As IList(Of SDVariable)) As IList(Of SDVariable)
			...
			Dim entropyGrad As IList(Of SDVariable) = Entropy.grad(sameDiff, arg(), f1(0), dimensions)
			Return Collections.singletonList(entropyGrad(0).div(sameDiff.math_Conflict.exp(outputVariable())))
		End Function
	End Class
