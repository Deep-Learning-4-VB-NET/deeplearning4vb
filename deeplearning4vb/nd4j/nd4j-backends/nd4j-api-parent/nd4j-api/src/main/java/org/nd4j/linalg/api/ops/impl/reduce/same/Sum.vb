...
'ORIGINAL LINE: @Slf4j public class Sum extends org.nd4j.linalg.api.ops.BaseReduceSameOp
	Public Class Sum
		...
		Public Sub New(ByVal x As INDArray, ByVal keepDims As Boolean, ParamArray ByVal dimensions() As Integer)
			Me.New(x, Nothing, keepDims, dimensions)
		End Sub
		...
		Public Overrides Function doDiff(ByVal i_v1 As IList(Of SDVariable)) As IList(Of SDVariable)
			...
			Return (New SumBp(sameDiff, arg(), i_v1(0), keepDims_Conflict, dimensions)).outputs()
		End Function
