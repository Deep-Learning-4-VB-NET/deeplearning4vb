...
'ORIGINAL LINE: @EqualsAndHashCode public class LossHinge implements org.nd4j.linalg.lossfunctions.ILossFunction
	<Serializable>
	Public Class LossHinge
	...
	'        
			...
			Dim bitMaskRowCol As INDArray = scoreArray(labels, preOutput, activationFn, mask)
	'        
	...
	'         
			...
			Dim dLda As INDArray = labels.neg().muli(bitMaskRowCol)
			...
			Dim gradients As INDArray = activationFn.backprop(preOutput, dLda).First 'TODO activation functions with parameters
