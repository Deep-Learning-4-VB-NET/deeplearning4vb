...
Namespace org.nd4j.linalg.api.ops.impl.scatter
	...
	Public Class ScatterNd
		Inherits DynamicCustomOp

		Public Sub New(ByVal sameDiff As SameDiff, ByVal indices As SDVariable, ByVal updates As SDVariable)
			MyBase.New(Nothing, sameDiff, New SDVariable(){indices, updates}, False)
		End Sub
		...
		Public Overrides Function calculateOutputDataTypes(ByVal inputDataTypes As IList(Of DataType)) As IList(Of DataType) 'Indices, updates, shape
			...
			Return Collections.singletonList(inputDataTypes(1))
		End Function
