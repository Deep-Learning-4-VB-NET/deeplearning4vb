...
'ORIGINAL LINE: @NoArgsConstructor public class Log1p extends org.nd4j.linalg.api.ops.BaseTransformStrictOp
	Public Class Log1p
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			SameDiffUtils.validateDifferentialFunctionSameDiff(sameDiff, arg(), Me)
			Return Collections.singletonList(i_v(0).div(arg().add(1.0)))
		End Function
