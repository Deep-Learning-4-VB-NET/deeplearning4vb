...
'ORIGINAL LINE: public GaussianDistribution(@NonNull INDArray z, double mean, double stddev)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public GaussianDistribution(@NonNull INDArray z, @NonNull INDArray means, double stddev)
		...
		''' <param name="z"> </param>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public GaussianDistribution(@NonNull INDArray z)
		...
		''' <param name="z"> </param>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public GaussianDistribution(@NonNull INDArray z, double stddev)
