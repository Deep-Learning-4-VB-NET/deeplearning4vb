...
'ORIGINAL LINE: @Data public class ArgMax extends org.nd4j.linalg.api.ops.impl.reduce.custom.BaseDynamicCustomIndexReduction
	Public Class ArgMax
		...
		Public Sub New(ByVal arr As INDArray)
			Me.New(New INDArray(){arr},False,Nothing)
		End Sub
