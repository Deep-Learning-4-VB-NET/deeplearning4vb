...
Imports AddBpOp = org.nd4j.linalg.api.ops.impl.transforms.pairwise.arithmetic.bp.AddBpOp
...
Namespace org.nd4j.linalg.api.ops.impl.transforms.pairwise.arithmetic
	...
	Public Class AddOp
		...
		Public Const OP_NAME As String = "add"

		Public Sub New()
		End Sub

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public AddOp(@NonNull SameDiff sameDiff, @NonNull SDVariable x, @NonNull SDVariable y)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: public AddOp(@NonNull INDArray x, @NonNull INDArray y)
		...
		Public Overrides Function doDiff(ByVal i_v As IList(Of SDVariable)) As IList(Of SDVariable)
			Return (New AddBpOp(sameDiff, larg(), rarg(), i_v(0))).outputs()
		End Function
