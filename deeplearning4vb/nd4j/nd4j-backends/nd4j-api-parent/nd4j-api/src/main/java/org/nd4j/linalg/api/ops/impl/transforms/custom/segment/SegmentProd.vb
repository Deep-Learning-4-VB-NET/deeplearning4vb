...
Imports SegmentProdBp = org.nd4j.linalg.api.ops.impl.transforms.segment.bp.SegmentProdBp
...
Namespace org.nd4j.linalg.api.ops.impl.transforms.custom.segment
	...
	Public Class SegmentProd
		...
		Public Overrides Function doDiff(ByVal gradients As IList(Of SDVariable)) As IList(Of SDVariable)
			Return (New SegmentProdBp(sameDiff, arg(0), arg(1), gradients(0))).outputs()
		End Function
