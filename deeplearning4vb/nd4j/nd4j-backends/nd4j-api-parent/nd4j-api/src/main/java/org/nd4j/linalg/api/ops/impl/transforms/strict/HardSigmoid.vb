...
'ORIGINAL LINE: @NoArgsConstructor public class HardSigmoid extends org.nd4j.linalg.api.ops.BaseTransformStrictOp
	Public Class HardSigmoid
		...
		Public Sub New(ByVal sameDiff As SameDiff, ByVal [in] As SDVariable, ByVal inPlace As Boolean)
			MyBase.New(sameDiff, [in], inPlace)
		End Sub
		...
		Public Overrides Function doDiff(ByVal f1 As IList(Of SDVariable)) As IList(Of SDVariable)
			Return (New HardSigmoidBp(sameDiff, arg(), f1(0))).outputs()
		End Function
