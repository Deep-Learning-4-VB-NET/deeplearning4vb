...
'ORIGINAL LINE: @Slf4j public abstract class BaseND4JTest
	Public MustInherit Class BaseND4JTest
		...
		Protected Friend integrationTest As Boolean?

		''' <returns> True if integration tests maven profile is enabled, false otherwise. </returns>
		Public Overridable ReadOnly Property IntegrationTests As Boolean
			Get
		...
		''' </summary>
		Public Overridable Sub skipUnlessIntegrationTests()
			assumeTrue(IntegrationTests,"Skipping integration test - integration profile is not enabled")
		End Sub

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @BeforeEach public void beforeTest(org.junit.jupiter.api.TestInfo testInfo)
		Public Overridable Sub beforeTest(ByVal testInfo As TestInfo)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @SneakyThrows @AfterEach public void afterTest(org.junit.jupiter.api.TestInfo testInfo)
		Public Overridable Sub afterTest(ByVal testInfo As TestInfo)
