...
Namespace org.nd4j.parameterserver.distributed.messages.intercom
	...
	Public Class DistributedIntroductionMessage
...
'ORIGINAL LINE: public DistributedIntroductionMessage(@NonNull String ip, int port)
		...
		Public Overrides Sub processMessage()
			transport.addClient(Me.ip, Me.port)
		End Sub
	End Class
