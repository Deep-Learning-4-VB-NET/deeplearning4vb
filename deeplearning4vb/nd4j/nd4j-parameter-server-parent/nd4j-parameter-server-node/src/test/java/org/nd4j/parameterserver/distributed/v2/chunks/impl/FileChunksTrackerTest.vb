...
'ORIGINAL LINE: @Slf4j @Disabled @Tag(TagNames.FILE_IO) @Tag(TagNames.DIST_SYSTEMS) @NativeTag public class FileChunksTrackerTest extends org.nd4j.common.tests.BaseND4JTest
	Public Class FileChunksTrackerTest
		Inherits BaseND4JTest

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Test public void testTracker_1() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub testTracker_1()
			...
			Dim messages As val = New List(Of )(splitter.split(message, 16384))

			Dim tracker As val = New FileChunksTracker(Of GradientsUpdateMessage)(messages.get(0))
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Test public void testDoubleSpending_1() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub testDoubleSpending_1()
			Dim array As val = Nd4j.linspace(1, 100000, 100000).reshape(ChrW(-1), 1000)
			Dim splitter As val = MessageSplitter.Instance
