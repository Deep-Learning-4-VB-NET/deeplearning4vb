...
Namespace org.deeplearning4j.models.sequencevectors.graph.primitives
	...
	Public Interface IGraph(Of V As org.deeplearning4j.models.sequencevectors.sequence.SequenceElement, E As Number)
...
'ORIGINAL LINE: public Vertex<V> getRandomConnectedVertex(int vertex, java.util.Random rng) throws org.deeplearning4j.models.sequencevectors.graph.exception.NoEdgesException;
