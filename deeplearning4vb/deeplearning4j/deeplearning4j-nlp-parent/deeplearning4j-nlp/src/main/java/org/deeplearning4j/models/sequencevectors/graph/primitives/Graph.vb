...
Namespace org.deeplearning4j.models.sequencevectors.graph.primitives
	...
	Public Class Graph(Of V As org.deeplearning4j.models.sequencevectors.sequence.SequenceElement, E As Number)
...
'ORIGINAL LINE: @SuppressWarnings("unchecked") public Graph(int numVertices, boolean allowMultipleEdges, org.deeplearning4j.models.sequencevectors.graph.vertex.VertexFactory<V> vertexFactory)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @SuppressWarnings("unchecked") public Graph(List<Vertex<V>> vertices, boolean allowMultipleEdges)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @SuppressWarnings("unchecked") public Graph(Collection<V> elements, boolean allowMultipleEdges)
		Public Sub New(ByVal elements As ICollection(Of V), ByVal allowMultipleEdges As Boolean)
			Me.vertices = New List(Of Vertex(Of V))()
			Me.allowMultipleEdges = allowMultipleEdges
			Dim idx As Integer = 0
			For Each element As V In elements
				Dim vertex As New Vertex(Of V)(idx, element)
				vertices.Add(vertex)
				idx += 1
			Next element
			edges = CType(Array.CreateInstance(GetType(System.Collections.IList), vertices.Count), IList(Of Edge(Of E))())
		...
		Public Overridable Sub addVertex(ByVal vertex As Vertex(Of V), ByVal edge As Edge(Of E))
			Me.addEdge(edge)
		End Sub

		Public Overridable Sub addVertex(ByVal vertex As Vertex(Of V), ByVal edges As ICollection(Of Edge(Of E)))

			For Each edge As Edge(Of E) In edges
				Me.addEdge(edge)
			Next edge
		End Sub

		Public Overridable Function numVertices() As Integer Implements IGraph(Of V, E).numVertices
			Return vertices.Count
		End Function

		Public Overridable Function getVertex(ByVal idx As Integer) As Vertex(Of V) Implements IGraph(Of V, E).getVertex
		...
		Public Overridable Function getVertices(ByVal indexes() As Integer) As IList(Of Vertex(Of V))
		...
		Public Overridable Function getVertices(ByVal from As Integer, ByVal [to] As Integer) As IList(Of Vertex(Of V))
		...
		Public Overridable Sub addEdge(ByVal edge As Edge(Of E)) Implements IGraph(Of V, E).addEdge
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Override @SuppressWarnings("unchecked") public List<Edge<E>> getEdgesOut(int vertex)
		Public Overridable Function getEdgesOut(ByVal vertex As Integer) As IList(Of Edge(Of E))
		...
		Public Overridable Function getVertexDegree(ByVal vertex As Integer) As Integer Implements IGraph(Of V, E).getVertexDegree
			If edges(vertex) Is Nothing Then
				Return 0
			End If
...
'ORIGINAL LINE: @Override public Vertex<V> getRandomConnectedVertex(int vertex, Random rng) throws org.deeplearning4j.models.sequencevectors.graph.exception.NoEdgesException
		Public Overridable Function getRandomConnectedVertex(ByVal vertex As Integer, ByVal rng As Random) As Vertex(Of V)
		...
		Public Overridable Function getConnectedVertices(ByVal vertex As Integer) As IList(Of Vertex(Of V))
			If vertex < 0 OrElse vertex >= vertices.Count Then
				Throw New System.ArgumentException("Invalid vertex index: " & vertex)
			End If
		...
		Public Overridable Function getConnectedVertexIndices(ByVal vertex As Integer) As Integer() Implements IGraph(Of V, E).getConnectedVertexIndices
