...
Namespace org.deeplearning4j.models.embeddings.learning
	...
	Public Interface ElementsLearningAlgorithm(Of T As org.deeplearning4j.models.sequencevectors.sequence.SequenceElement)
		...
		Function learnSequence(ByVal sequence As Sequence(Of T), ByVal nextRandom As AtomicLong, ByVal learningRate As Double) As Double
