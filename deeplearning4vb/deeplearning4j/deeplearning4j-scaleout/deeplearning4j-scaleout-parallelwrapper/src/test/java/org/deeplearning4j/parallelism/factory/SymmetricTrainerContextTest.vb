...
'ORIGINAL LINE: @Tag(TagNames.FILE_IO) @NativeTag public class SymmetricTrainerContextTest extends org.deeplearning4j.BaseDL4JTest
...
'ORIGINAL LINE: @Test public void testEqualUuid1()
		Public Overridable Sub testEqualUuid1()
			...
			Dim trainer As val = New SymmetricTrainer(model, "alpha", 3, WorkspaceMode.NONE, wrapper, True)
