...
Namespace org.deeplearning4j.spark.models.sequencevectors.export
	...
	Public Interface SparkModelExporter(Of T As org.deeplearning4j.models.sequencevectors.sequence.SequenceElement)
		...
		Sub export(ByVal rdd As JavaRDD(Of ExportContainer(Of T)))
	End Interface
