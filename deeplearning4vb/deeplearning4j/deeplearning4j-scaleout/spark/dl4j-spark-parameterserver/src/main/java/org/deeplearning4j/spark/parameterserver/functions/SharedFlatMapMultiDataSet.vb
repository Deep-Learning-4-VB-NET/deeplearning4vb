...
Namespace org.deeplearning4j.spark.parameterserver.functions
	...
	Public Class SharedFlatMapMultiDataSet(Of R As org.deeplearning4j.spark.api.TrainingResult)
...
'JAVA TO VB CONVERTER TODO TASK: Java iterators are only converted within the context of 'while' and 'for' loops:
	...
	'         
			...
			SharedTrainingWrapper.getInstance(worker.InstanceId).attachMDS(dataSetIterator)
