...
'ORIGINAL LINE: @Slf4j public class ScoreExamplesFunction implements org.apache.spark.api.java.function.DoubleFlatMapFunction<java.util.Iterator<org.nd4j.linalg.dataset.api.MultiDataSet>>
	Public Class ScoreExamplesFunction
		Implements DoubleFlatMapFunction(Of IEnumerator(Of MultiDataSet))
...
'ORIGINAL LINE: @Override public java.util.Iterator<Double> call(java.util.Iterator<org.nd4j.linalg.dataset.api.MultiDataSet> iterator) throws Exception
		Public Overrides Function [call](ByVal iterator As IEnumerator(Of MultiDataSet)) As IEnumerator(Of Double)
