...
Namespace org.deeplearning4j.spark.data
	...
	Public Class PathToMultiDataSetFunction
		Implements [Function](Of String, MultiDataSet)
...
'ORIGINAL LINE: @Override public org.nd4j.linalg.dataset.api.MultiDataSet call(String path) throws Exception
		Public Overrides Function [call](ByVal path As String) As MultiDataSet
