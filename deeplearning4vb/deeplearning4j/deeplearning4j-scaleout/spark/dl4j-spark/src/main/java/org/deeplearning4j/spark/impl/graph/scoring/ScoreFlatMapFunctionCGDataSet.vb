...
Namespace org.deeplearning4j.spark.impl.graph.scoring
	...
	Public Class ScoreFlatMapFunctionCGDataSet
		Implements FlatMapFunction(Of IEnumerator(Of DataSet), Tuple2(Of Long, Double))

		Private Shared ReadOnly log As Logger = LoggerFactory.getLogger(GetType(ScoreFlatMapFunctionCGDataSet))
...
'ORIGINAL LINE: @Override public java.util.Iterator<scala.Tuple2<Long, Double>> call(java.util.Iterator<org.nd4j.linalg.dataset.DataSet> dataSetIterator) throws Exception
		Public Overrides Function [call](ByVal dataSetIterator As IEnumerator(Of DataSet)) As IEnumerator(Of Tuple2(Of Long, Double))
'JAVA TO VB CONVERTER TODO TASK: Java iterators are only converted within the context of 'while' and 'for' loops:
			...
			Do While iter.MoveNext()
				...
				Dim numExamples As Long = ds.Features.size(0)
