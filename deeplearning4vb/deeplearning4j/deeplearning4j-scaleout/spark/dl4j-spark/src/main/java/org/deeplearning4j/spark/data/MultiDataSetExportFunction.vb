...
Namespace org.deeplearning4j.spark.data
	...
	Public Class MultiDataSetExportFunction
		Implements VoidFunction(Of IEnumerator(Of MultiDataSet))
...
'ORIGINAL LINE: @Override public void call(java.util.Iterator<org.nd4j.linalg.dataset.api.MultiDataSet> iter) throws Exception
		Public Overrides Sub [call](ByVal iter As IEnumerator(Of MultiDataSet))
...
'ORIGINAL LINE: String filename = "mds_" + uid + "_" + (outputCount++) + ".bin";
				Dim filename As String = "mds_" & uid & "_" & (outputCount) & ".bin"
					outputCount += 1
