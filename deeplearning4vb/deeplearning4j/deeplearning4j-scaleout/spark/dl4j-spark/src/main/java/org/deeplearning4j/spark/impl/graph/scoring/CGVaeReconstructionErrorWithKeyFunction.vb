...
Namespace org.deeplearning4j.spark.impl.graph.scoring
	...
	Public Class CGVaeReconstructionErrorWithKeyFunction(Of K)
		...
		Public Overrides ReadOnly Property VaeLayer As VariationalAutoencoder
			Get
				...
				If Not (TypeOf l Is VariationalAutoencoder) Then
					Throw New Exception("Cannot use CGVaeReconstructionErrorWithKeyFunction on network that doesn't have a VAE " & "layer as layer 0. Layer type: " & l.GetType())
				End If
