...
Namespace org.deeplearning4j.datasets.iterator
	...
	Public Interface DataSetFetcher
		...
		''' <summary>
		''' Direct access to a number represenative of iterating through a dataset </summary>
