...
'ORIGINAL LINE: @DisplayName("Keras Convolution 2 D Test") @Tag(TagNames.FILE_IO) @Tag(TagNames.KERAS) @NativeTag class KerasConvolution2DTest extends org.deeplearning4j.BaseDL4JTest
	Friend Class KerasConvolution2DTest
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Test @DisplayName("Test Convolution 2 D Layer") void testConvolution2DLayer() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Friend Overridable Sub testConvolution2DLayer()
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: private void buildConvolution2DLayer(org.deeplearning4j.nn.modelimport.keras.config.KerasLayerConfiguration conf, System.Nullable<Integer> kerasVersion, boolean withDilation) throws Exception
		Private Sub buildConvolution2DLayer(ByVal conf As KerasLayerConfiguration, ByVal kerasVersion As Integer?, ByVal withDilation As Boolean)
...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
			...
			Dim layer As ConvolutionLayer = (New KerasConvolution2D(layerConfig)).Convolution2DLayer
