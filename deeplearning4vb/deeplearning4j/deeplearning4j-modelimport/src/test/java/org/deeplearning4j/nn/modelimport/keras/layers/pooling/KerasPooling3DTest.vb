...
'ORIGINAL LINE: @DisplayName("Keras Pooling 3 D Test") @Tag(TagNames.FILE_IO) @Tag(TagNames.KERAS) @NativeTag class KerasPooling3DTest extends org.deeplearning4j.BaseDL4JTest
	Friend Class KerasPooling3DTest
		Inherits BaseDL4JTest

		Private ReadOnly LAYER_NAME As String = "pooling_3d"

		Private ReadOnly KERNEL_SIZE() As Integer = { 2, 2, 2 }

		Private ReadOnly STRIDE() As Integer = { 1, 1, 1 }
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Test @DisplayName("Test Pooling 3 D Layer") void testPooling3DLayer() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Friend Overridable Sub testPooling3DLayer()
			buildPooling3DLayer(conf1, keras1)
			buildPooling3DLayer(conf2, keras2)
		End Sub

'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: private void buildPooling3DLayer(org.deeplearning4j.nn.modelimport.keras.config.KerasLayerConfiguration conf, System.Nullable<Integer> kerasVersion) throws Exception
		Private Sub buildPooling3DLayer(ByVal conf As KerasLayerConfiguration, ByVal kerasVersion As Integer?)
			Dim layerConfig As IDictionary(Of String, Object) = New Dictionary(Of String, Object)()
			layerConfig(conf.getLAYER_FIELD_CLASS_NAME()) = conf.getLAYER_CLASS_NAME_MAX_POOLING_3D()
			...
			Dim layer As Subsampling3DLayer = (New KerasPooling3D(layerConfig)).Subsampling3DLayer
