...
'ORIGINAL LINE: @DisplayName("Keras Spatial Dropout 2 D Test") @Tag(TagNames.FILE_IO) @Tag(TagNames.KERAS) @NativeTag class KerasSpatialDropout2DTest extends org.deeplearning4j.BaseDL4JTest
	Friend Class KerasSpatialDropout2DTest
		Inherits BaseDL4JTest

		Friend LAYER_NAME As String = "spatial_dropout_2d"
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Test @DisplayName("Test Spatial Dropout Layer") void testSpatialDropoutLayer() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Friend Overridable Sub testSpatialDropoutLayer()
			buildSpatialDropoutLayer(conf1, keras1)
			buildSpatialDropoutLayer(conf2, keras2)
		End Sub

'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: private void buildSpatialDropoutLayer(org.deeplearning4j.nn.modelimport.keras.config.KerasLayerConfiguration conf, System.Nullable<Integer> kerasVersion) throws Exception
		Private Sub buildSpatialDropoutLayer(ByVal conf As KerasLayerConfiguration, ByVal kerasVersion As Integer?)
			Dim layerConfig As IDictionary(Of String, Object) = New Dictionary(Of String, Object)()
			layerConfig(conf.getLAYER_FIELD_CLASS_NAME()) = conf.getLAYER_CLASS_NAME_SPATIAL_DROPOUT_2D()
			...
			Dim layer As DropoutLayer = (New KerasSpatialDropout(layerConfig)).SpatialDropoutLayer
