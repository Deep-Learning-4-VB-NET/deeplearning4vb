...
'ORIGINAL LINE: @DisplayName("Keras Locally Connected 2 D Test") @Tag(TagNames.FILE_IO) @Tag(TagNames.KERAS) @NativeTag class KerasLocallyConnected2DTest extends org.deeplearning4j.BaseDL4JTest
	Friend Class KerasLocallyConnected2DTest
...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
			...
			Dim kerasLocal As New KerasLocallyConnected2D(layerConfig)
			...
			Dim layer As LocallyConnected2D = kerasLocal.LocallyConnected2DLayer
			...
			assertArrayEquals(layer.getInputSize(), New Integer() { 4, 4 })
