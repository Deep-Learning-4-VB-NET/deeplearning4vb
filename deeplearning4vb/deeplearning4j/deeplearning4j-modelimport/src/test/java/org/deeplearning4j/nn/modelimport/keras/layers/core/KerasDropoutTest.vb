...
'ORIGINAL LINE: @DisplayName("Keras Dropout Test") @Tag(TagNames.FILE_IO) @Tag(TagNames.KERAS) @NativeTag class KerasDropoutTest extends org.deeplearning4j.BaseDL4JTest
	Friend Class KerasDropoutTest
		Inherits BaseDL4JTest

		Friend LAYER_NAME As String = "dropout"
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Test @DisplayName("Test Dropout Layer") void testDropoutLayer() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Friend Overridable Sub testDropoutLayer()
			buildDropoutLayer(conf1, keras1)
			buildDropoutLayer(conf2, keras2)
		End Sub

'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: private void buildDropoutLayer(org.deeplearning4j.nn.modelimport.keras.config.KerasLayerConfiguration conf, System.Nullable<Integer> kerasVersion) throws Exception
		Private Sub buildDropoutLayer(ByVal conf As KerasLayerConfiguration, ByVal kerasVersion As Integer?)
			...
			Dim layer As DropoutLayer = (New KerasDropout(layerConfig)).DropoutLayer
