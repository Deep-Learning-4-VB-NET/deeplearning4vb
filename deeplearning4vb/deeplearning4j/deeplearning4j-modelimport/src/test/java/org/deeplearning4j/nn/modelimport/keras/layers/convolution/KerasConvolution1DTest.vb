...
Imports KerasConvolution1D = org.deeplearning4j.nn.modelimport.keras.layers.convolutional.KerasConvolution1D
...
'ORIGINAL LINE: @DisplayName("Keras Convolution 1 D Test") @Tag(TagNames.FILE_IO) @Tag(TagNames.KERAS) @NativeTag class KerasConvolution1DTest extends org.deeplearning4j.BaseDL4JTest
	Friend Class KerasConvolution1DTest
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Test @DisplayName("Test Convolution 1 D Layer") void testConvolution1DLayer() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Friend Overridable Sub testConvolution1DLayer()
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: private void buildConvolution1DLayer(org.deeplearning4j.nn.modelimport.keras.config.KerasLayerConfiguration conf, System.Nullable<Integer> kerasVersion, boolean withDilation) throws Exception
		Private Sub buildConvolution1DLayer(ByVal conf As KerasLayerConfiguration, ByVal kerasVersion As Integer?, ByVal withDilation As Boolean)
...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
			...
			Dim layer As Convolution1DLayer = (New KerasConvolution1D(layerConfig)).Convolution1DLayer
