...
'ORIGINAL LINE: @DisplayName("Keras Gaussian Dropout Test") @Tag(TagNames.FILE_IO) @Tag(TagNames.KERAS) @NativeTag class KerasGaussianDropoutTest extends org.deeplearning4j.BaseDL4JTest
	Friend Class KerasGaussianDropoutTest
		Inherits BaseDL4JTest

		Friend LAYER_NAME As String = "gaussian_dropout"
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Test @DisplayName("Test Gaussian Dropout Layer") void testGaussianDropoutLayer() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Friend Overridable Sub testGaussianDropoutLayer()
			buildGaussianDropoutLayer(conf1, keras1)
			buildGaussianDropoutLayer(conf2, keras2)
		End Sub

'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: private void buildGaussianDropoutLayer(org.deeplearning4j.nn.modelimport.keras.config.KerasLayerConfiguration conf, System.Nullable<Integer> kerasVersion) throws Exception
		Private Sub buildGaussianDropoutLayer(ByVal conf As KerasLayerConfiguration, ByVal kerasVersion As Integer?)
			...
			Dim layer As DropoutLayer = (New KerasGaussianDropout(layerConfig)).GaussianDropoutLayer
