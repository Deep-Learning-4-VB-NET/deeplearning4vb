...
Imports KerasDeconvolution2D = org.deeplearning4j.nn.modelimport.keras.layers.convolutional.KerasDeconvolution2D
...
'ORIGINAL LINE: @DisplayName("Keras Deconvolution 2 D Test") @Tag(TagNames.FILE_IO) @Tag(TagNames.KERAS) @NativeTag class KerasDeconvolution2DTest extends org.deeplearning4j.BaseDL4JTest
	Friend Class KerasDeconvolution2DTest
		...
		Private ReadOnly LAYER_NAME As String = "deconvolution_layer"
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Test @DisplayName("Test Deconvolution 2 D Layer") void testDeconvolution2DLayer() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Friend Overridable Sub testDeconvolution2DLayer()
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: private void buildDeconvolution2DLayer(org.deeplearning4j.nn.modelimport.keras.config.KerasLayerConfiguration conf, System.Nullable<Integer> kerasVersion, boolean withDilation) throws Exception
		Private Sub buildDeconvolution2DLayer(ByVal conf As KerasLayerConfiguration, ByVal kerasVersion As Integer?, ByVal withDilation As Boolean)
			Dim layerConfig As IDictionary(Of String, Object) = New Dictionary(Of String, Object)()
			layerConfig(conf.getLAYER_FIELD_CLASS_NAME()) = conf.getLAYER_CLASS_NAME_DECONVOLUTION_2D()
...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
			...
			Dim layer As Deconvolution2D = (New KerasDeconvolution2D(layerConfig)).Deconvolution2DLayer
