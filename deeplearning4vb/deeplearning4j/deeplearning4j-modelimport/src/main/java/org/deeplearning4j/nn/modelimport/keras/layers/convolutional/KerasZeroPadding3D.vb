...
'ORIGINAL LINE: @Slf4j @Data @EqualsAndHashCode(callSuper = false) public class KerasZeroPadding3D extends org.deeplearning4j.nn.modelimport.keras.KerasLayer
...
'ORIGINAL LINE: public KerasZeroPadding3D(java.util.Map<String, Object> layerConfig) throws InvalidKerasConfigurationException, org.deeplearning4j.nn.modelimport.keras.exceptions.UnsupportedKerasConfigurationException
		...
		''' <exception cref="UnsupportedKerasConfigurationException"> Unsupported Keras config </exception>
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
'ORIGINAL LINE: public KerasZeroPadding3D(java.util.Map<String, Object> layerConfig, boolean enforceTrainingConfig) throws InvalidKerasConfigurationException, org.deeplearning4j.nn.modelimport.keras.exceptions.UnsupportedKerasConfigurationException
		Public Sub New(ByVal layerConfig As IDictionary(Of String, Object), ByVal enforceTrainingConfig As Boolean)
			...
			Dim padding() As Integer = getPaddingFromConfig(layerConfig, conf, paddingField,3)
			Dim builder As ZeroPadding3DLayer.Builder = (New ZeroPadding3DLayer.Builder(padding)).name(Me.layerName_Conflict).dropOut(Me.dropout)
		...
		''' </summary>
		''' <returns>  ZeroPadding3DLayer </returns>
		Public Overridable ReadOnly Property ZeroPadding3DLayer As ZeroPadding3DLayer
			Get
				Return DirectCast(Me.layer_Conflict, ZeroPadding3DLayer)
			End Get
		End Property
...
'ORIGINAL LINE: @Override public org.deeplearning4j.nn.conf.inputs.InputType getOutputType(org.deeplearning4j.nn.conf.inputs.InputType... inputType) throws org.deeplearning4j.nn.modelimport.keras.exceptions.InvalidKerasConfigurationException
		Public Overrides Function getOutputType(ParamArray ByVal inputType() As InputType) As InputType
			...
			End If
			Return Me.ZeroPadding3DLayer.getOutputType(-1, inputType(0))
		End Function
	End Class
