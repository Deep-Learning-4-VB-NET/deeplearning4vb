...
'ORIGINAL LINE: @Data @NoArgsConstructor public class WeightInitVarScalingUniformFanOut implements IWeightInit
	<Serializable>
	Public Class WeightInitVarScalingUniformFanOut
