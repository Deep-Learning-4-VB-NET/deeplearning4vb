...
'ORIGINAL LINE: @Data @NoArgsConstructor public class WeightInitVarScalingNormalFanIn implements IWeightInit
	<Serializable>
	Public Class WeightInitVarScalingNormalFanIn
...
'JAVA TO VB CONVERTER WARNING: Java to VB Converter cannot determine whether both operands of this division are integer types - if they are then you should use the VB integer division operator:
				std = Math.Sqrt(scale.Value / fanIn)
			End If
