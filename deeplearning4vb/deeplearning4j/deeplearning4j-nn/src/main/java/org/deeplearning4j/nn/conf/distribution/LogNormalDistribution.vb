...
'ORIGINAL LINE: @EqualsAndHashCode(callSuper = false) @Data public class LogNormalDistribution extends Distribution
	<Serializable>
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @JsonCreator public LogNormalDistribution(@JsonProperty("mean") double mean, @JsonProperty("std") double std)
		...
		Public Overrides Function ToString() As String
			Return "LogNormalDistribution(" & "mean=" & mean & ", std=" & std & ")"c
		End Function
	End Class
