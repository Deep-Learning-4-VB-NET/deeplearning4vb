...
'ORIGINAL LINE: @AllArgsConstructor @Builder public class VGG16 extends org.deeplearning4j.zoo.ZooModel
	Public Class VGG16
		Inherits ZooModel
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Builder.@Default private org.deeplearning4j.nn.conf.CacheMode cacheMode = org.deeplearning4j.nn.conf.CacheMode.NONE;
		Private cacheMode As CacheMode = CacheMode.NONE
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Builder.@Default private org.deeplearning4j.nn.conf.WorkspaceMode workspaceMode = org.deeplearning4j.nn.conf.WorkspaceMode.ENABLED;
...
'ORIGINAL LINE: @Builder.@Default private org.deeplearning4j.nn.conf.layers.ConvolutionLayer.AlgoMode cudnnAlgoMode = org.deeplearning4j.nn.conf.layers.ConvolutionLayer.AlgoMode.PREFER_FASTEST;
		...
		Public Overrides Function pretrainedUrl(ByVal pretrainedType As PretrainedType) As String
			...
			ElseIf pretrainedType = PretrainedType.CIFAR10 Then
				Return DL4JResources.getURLString("models/vgg16_dl4j_cifar10_inference.v1.zip")
			ElseIf pretrainedType = PretrainedType.VGGFACE Then
		...
		Public Overrides Function pretrainedChecksum(ByVal pretrainedType As PretrainedType) As Long
			If pretrainedType = PretrainedType.IMAGENET Then
				Return 3501732770L
			End If
			If pretrainedType = PretrainedType.CIFAR10 Then
				Return 2192260131L
			End If
			If pretrainedType = PretrainedType.VGGFACE Then
				Return 2706403553L
			Else
				Return 0L
			End If
