...
'ORIGINAL LINE: @Disabled @NativeTag @Tag(TagNames.DL4J_OLD_API) public class RegressionTest100b4 extends org.deeplearning4j.BaseDL4JTest
	Public Class RegressionTest100b4
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub testCustomLayer()
			...
			For Each dtype As DataType In New DataType(){DataType.DOUBLE, DataType.FLOAT, DataType.HALF}
				...
				Dim f As File = Resources.asFile("regression_testing/100b4/CustomLayerExample_100b4_" & dtypeName & ".bin")
	...
	'            net = net.clone();
				...
				Dim f2 As File = Resources.asFile("regression_testing/100b4/CustomLayerExample_Output_100b4_" & dtypeName & ".bin")
				Using dis As New java.io.DataInputStream(New FileStream(f2, FileMode.Open, FileAccess.Read))
					outExp = Nd4j.read(dis)
				End Using

				Dim [in] As INDArray
				Dim f3 As File = Resources.asFile("regression_testing/100b4/CustomLayerExample_Input_100b4_" & dtypeName & ".bin")
				...
				assertTrue(eq,"Test for dtype: " & dtypeName & vbLf & outExp & " vs " & outAct)
			Next dtype
		End Sub
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub testLSTM()
			...
			Dim f As File = Resources.asFile("regression_testing/100b4/GravesLSTMCharModelingExample_100b4.bin")
			Dim net As MultiLayerNetwork = MultiLayerNetwork.load(f, True)
			...
			Dim outExp As INDArray
			Dim f2 As File = Resources.asFile("regression_testing/100b4/GravesLSTMCharModelingExample_Output_100b4.bin")
			Using dis As New java.io.DataInputStream(New FileStream(f2, FileMode.Open, FileAccess.Read))
				outExp = Nd4j.read(dis)
			End Using

			Dim [in] As INDArray
			Dim f3 As File = Resources.asFile("regression_testing/100b4/GravesLSTMCharModelingExample_Input_100b4.bin")
			Using dis As New java.io.DataInputStream(New FileStream(f3, FileMode.Open, FileAccess.Read))
				[in] = Nd4j.read(dis)
			End Using
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub testVae()
			...
			Dim f As File = Resources.asFile("regression_testing/100b4/VaeMNISTAnomaly_100b4.bin")
			Dim net As MultiLayerNetwork = MultiLayerNetwork.load(f, True)
			...
			Dim outExp As INDArray
			Dim f2 As File = Resources.asFile("regression_testing/100b4/VaeMNISTAnomaly_Output_100b4.bin")
			Using dis As New java.io.DataInputStream(New FileStream(f2, FileMode.Open, FileAccess.Read))
				outExp = Nd4j.read(dis)
			End Using

			Dim [in] As INDArray
			Dim f3 As File = Resources.asFile("regression_testing/100b4/VaeMNISTAnomaly_Input_100b4.bin")
			Using dis As New java.io.DataInputStream(New FileStream(f3, FileMode.Open, FileAccess.Read))
				[in] = Nd4j.read(dis)
			End Using
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Test @Disabled("Failing due to new data format changes. Sept 10,2020") public void testYoloHouseNumber() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub testYoloHouseNumber()

			Dim f As File = Resources.asFile("regression_testing/100b4/HouseNumberDetection_100b4.bin")
			...
			Dim outExp As INDArray
			Dim f2 As File = Resources.asFile("regression_testing/100b4/HouseNumberDetection_Output_100b4.bin")
			Using dis As New java.io.DataInputStream(New FileStream(f2, FileMode.Open, FileAccess.Read))
				outExp = Nd4j.read(dis)
			End Using

			Dim [in] As INDArray
			Dim f3 As File = Resources.asFile("regression_testing/100b4/HouseNumberDetection_Input_100b4.bin")
			Using dis As New java.io.DataInputStream(New FileStream(f3, FileMode.Open, FileAccess.Read))
				[in] = Nd4j.read(dis)
			End Using
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'ORIGINAL LINE: @Test @Disabled("failing due to new input data format changes.") public void testSyntheticCNN() throws Exception
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub testSyntheticCNN()

			Dim f As File = Resources.asFile("regression_testing/100b4/SyntheticCNN_100b4.bin")
			Dim net As MultiLayerNetwork = MultiLayerNetwork.load(f, True)
			...
			Dim outExp As INDArray
			Dim f2 As File = Resources.asFile("regression_testing/100b4/SyntheticCNN_Output_100b4.bin")
			Using dis As New java.io.DataInputStream(New FileStream(f2, FileMode.Open, FileAccess.Read))
				outExp = Nd4j.read(dis)
			End Using

			Dim [in] As INDArray
			Dim f3 As File = Resources.asFile("regression_testing/100b4/SyntheticCNN_Input_100b4.bin")
			Using dis As New java.io.DataInputStream(New FileStream(f3, FileMode.Open, FileAccess.Read))
				[in] = Nd4j.read(dis)
			End Using
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub testSyntheticBidirectionalRNNGraph()
			...
			Dim f As File = Resources.asFile("regression_testing/100b4/SyntheticBidirectionalRNNGraph_100b4.bin")
			Dim net As ComputationGraph = ComputationGraph.load(f, True)
			...
			Dim outExp As INDArray
			Dim f2 As File = Resources.asFile("regression_testing/100b4/SyntheticBidirectionalRNNGraph_Output_100b4.bin")
			Using dis As New java.io.DataInputStream(New FileStream(f2, FileMode.Open, FileAccess.Read))
				outExp = Nd4j.read(dis)
			End Using

			Dim [in] As INDArray
			Dim f3 As File = Resources.asFile("regression_testing/100b4/SyntheticBidirectionalRNNGraph_Input_100b4.bin")
			Using dis As New java.io.DataInputStream(New FileStream(f3, FileMode.Open, FileAccess.Read))
				[in] = Nd4j.read(dis)
			End Using
