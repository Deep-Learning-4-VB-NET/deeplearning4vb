...
'ORIGINAL LINE: @NativeTag @Tag(TagNames.DL4J_OLD_API) public class RegressionTest060 extends org.deeplearning4j.BaseDL4JTest
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub regressionTestMLP1()
			...
			Dim f As File = Resources.asFile("regression_testing/060/060_ModelSerializer_Regression_MLP_1.zip")
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub regressionTestMLP2()
			...
			Dim f As File = Resources.asFile("regression_testing/060/060_ModelSerializer_Regression_MLP_2.zip")
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub regressionTestCNN1()
			...
			Dim f As File = Resources.asFile("regression_testing/060/060_ModelSerializer_Regression_CNN_1.zip")
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub regressionTestLSTM1()
			...
			Dim f As File = Resources.asFile("regression_testing/060/060_ModelSerializer_Regression_LSTM_1.zip")
...
'JAVA TO VB CONVERTER WARNING: Method 'throws' clauses are not available in VB:
		Public Overridable Sub regressionTestCGLSTM1()
			...
			Dim f As File = Resources.asFile("regression_testing/060/060_ModelSerializer_Regression_CG_LSTM_1.zip")
