...
'ORIGINAL LINE: @EqualsAndHashCode(callSuper = false) public class SDLossMAE extends org.nd4j.linalg.lossfunctions.SameDiffLoss
	<Serializable>
	Public Class SDLossMAE
		...
		Public Overrides Function defineLoss(ByVal sd As SameDiff, ByVal layerInput As SDVariable, ByVal labels As SDVariable) As SDVariable
			Return sd.math_Conflict.abs(labels.sub(layerInput)).mean(1)
		End Function
	End Class
