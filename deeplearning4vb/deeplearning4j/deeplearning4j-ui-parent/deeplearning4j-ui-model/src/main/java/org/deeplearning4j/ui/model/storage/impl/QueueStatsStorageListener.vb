...
'ORIGINAL LINE: @AllArgsConstructor public class QueueStatsStorageListener implements org.deeplearning4j.core.storage.StatsStorageListener
	Public Class QueueStatsStorageListener
		Implements StatsStorageListener

		Private ReadOnly queue As LinkedList(Of StatsStorageEvent)
