...
'ORIGINAL LINE: @AllArgsConstructor public class QueuePairStatsStorageListener implements org.deeplearning4j.core.storage.StatsStorageListener
	Public Class QueuePairStatsStorageListener
		Implements StatsStorageListener

		Private ReadOnly statsStorage As StatsStorage
		Private ReadOnly queue As LinkedList(Of Pair(Of StatsStorage, StatsStorageEvent))

		Public Overridable Sub notify(ByVal [event] As StatsStorageEvent)
			queue.AddLast(New Pair(Of )(statsStorage, [event]))
		End Sub
	End Class
