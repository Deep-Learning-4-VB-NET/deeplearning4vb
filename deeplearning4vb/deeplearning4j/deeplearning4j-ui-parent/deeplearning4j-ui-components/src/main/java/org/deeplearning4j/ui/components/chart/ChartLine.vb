...
'ORIGINAL LINE: @Data @EqualsAndHashCode(callSuper = true) @JsonInclude(JsonInclude.Include.NON_NULL) public class ChartLine extends Chart
	Public Class ChartLine
		Inherits Chart

		Public Const COMPONENT_TYPE As String = "ChartLine"
		...
		Public Class Builder
			...
			Friend showLegend As Boolean = True
			...
			Public Overridable Function build() As ChartLine
				Return New ChartLine(Me)
			End Function
